...
//
const getQuarter = (value) => window.moment(value).quarter()
const getYear = (value) => window.moment(value).format("YYYY")
...
new CustomApexChart({
    ...
    options: () => ({
        ...
        tooltip: {
            x: {
                formatter: function (val) {
                    return "Q" + getQuarter(val) + " " + getYear(val)
                }
            }
        },
        grid: {
