...
@section('content')
    ...
    <div class="outlook-box">
                ...
                <div class="card-header p-3 border-light card-bg d-block">
                    <div class="d-flex gap-2">
                        <div class="app-search flex-grow-1">
                            <input data-chat-search type="text" class="form-control bg-light-subtle border-light"
                    ...
                    <div class="list-group list-group-flush chat-list">
                        ...
                        <a href="#!" data-chat-id="chat1"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Ava
                                        Thompson</span>
                        ...
                        <a href="#!" data-chat-id="chat2"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Noah
                                        Smith</span>
                        ...
                        <a href="#!" data-chat-id="chat3"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Liam
                                        Johnson</span>
                        ...
                        <a href="#!" data-chat-id="chat4"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Emma
                                        Wilson</span>
                        ...
                        <a href="#!" data-chat-id="chat5"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Olivia
                                        Martinez</span>
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field
                                        class="text-nowrap fw-semibold fs-base mb-0 lh-base">William Davis</span>
                        ...
                        <a href="#!" data-chat-id="chat7"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field
                                        class="text-nowrap fw-semibold fs-base mb-0 lh-base">Sophia Moore</span>
                        ...
                        <a href="#!" data-chat-id="chat8"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field
                                        class="text-nowrap fw-semibold fs-base mb-0 lh-base">Jackson Lee</span>
                        ...
                        <a href="#!" data-chat-id="chat9"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Chloe
                                        Anderson</span>
                        ...
                        <a href="#!" data-chat-id="chat10"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Lucas
                                        Wright</span>
                        ...
                        <a href="#!" data-chat-id="chat11"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field class="text-nowrap fw-semibold fs-base mb-0 lh-base">Mia
                                        Scott</span>
                        ...
                        <a href="#!" data-chat-id="chat12"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                ...
                                <span class="overflow-hidden">
                                    <span data-chat-search-field
                                        class="text-nowrap fw-semibold fs-base mb-0 lh-base">Benjamin Clark</span>
        ...
        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1">
            <div class="card-header card-bg">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-1 lh-base fs-lg">
                        <a data-chat-username href="{{ route('second', ['pages', 'profile']) }}" class="link-reset">Noah
                            Smith</a>
                    </h5>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <!-- More Options -->
                    <div class="dropdown">
                        <button type="button" class="btn btn-default btn-icon" data-bs-toggle="dropdown"
            ...
            <div id="chat-container" data-chat class="card-body pt-0 mb-5 pb-2" data-simplebar
            ...
            <div
                ...
                <div class="d-flex gap-2">
                    <div class="app-search flex-grow-1">
                        <input data-chat-input type="text" class="form-control py-2 bg-light-subtle border-light"
