                        ...
                        <div class="card-header align-items-start p-4">
                            ...
                            <div class="ms-auto">
                                <a href="javascript: void(0);" class="btn btn-light"><i class="ti ti-pencil me-1"></i>
                                    Modify</a>
                                <a href="javascript: void(0);" class="btn btn-danger"><i class="ti ti-trash me-1"></i>
                                    Delete</a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="avatar-md me-3">
                                                        <img src="/images/products/1.png" alt="Wireless Earbuds"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="avatar-md me-3">
                                                        <img src="/images/products/2.png" alt="Smart Watch"
                                                            class="img-fluid rounded">
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="avatar-md me-3">
                                                        <img src="/images/products/3.png" alt="Gaming Mouse"
                                                            class="img-fluid rounded">
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                                class="link-reset">Gaming Mouse</a>
                                                        </h5>
                                ...
                                <div class="timeline-item d-flex align-items-stretch">
                                    ...
                                    <div class="timeline-content ps-3 pb-5">
                                        ...
                                        <p class="mb-1 text-muted">The package is out for delivery and will reach you
                                            shortly.</p>
                                        <p class="mb-1 text-muted fs-xxs">Tracking No: <a href="#!"
                                                class="link-primary fw-semibold text-decoration-underline">TRK123456789</a>
                                        </p>
                ...
                <div class="col-xl-3">
                    <div class="card">
                        <div class="card-header justify-content-between border-dashed">
                            ...
                            <a href="#!" class="btn btn-default btn-sm btn-icon rounded-circle"><i
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    <h5 class="mb-1 d-flex align-items-center">
                                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset">Sophia
                                            Carter</a>
                                        <img src="/images/flags/gb.svg" alt="UK" class="ms-2 rounded-circle"
                                            height="16">
                                    </h5>
