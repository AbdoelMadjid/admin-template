                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="/images/cards/stripe.svg" alt="" class="me-2" height="28">
                                    xxxx
                                    9901
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                <td>
                                    <img src="/images/cards/discover-card.svg" alt="" class="me-2"
                                        height="28"> xxxx 1234
                                </td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-soft-info fs-xxs">Shipped</span></td>
                                <td>
                                    <img src="/images/cards/google-wallet.svg" alt="" class="me-2"
                                        height="28"> xxx@google
                                </td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
