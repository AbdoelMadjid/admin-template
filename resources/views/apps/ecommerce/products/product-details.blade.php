                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="text-center my-3">
                                        <a href="{{ route('third', ['apps', 'ecommerce', 'add-product']) }}"
                                            class="btn btn-light me-1"><i class="ti ti-pencil fs-lg me-1"></i> Edit</a>
                                        <a href="{{ route('third', ['apps', 'ecommerce', 'add-product']) }}"
                                            class="btn btn-danger"><i class="ti ti-circle-dashed-x fs-lg me-1"></i>
                                            Delisting</a>
                                    </div>
                                </div> <!-- end card-body-->
                            </div> <!-- end card-->
