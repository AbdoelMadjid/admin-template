            ...
            <form class="bg-light-subtle rounded border p-3">
                <div class="d-flex flex-wrap justify align-items-center gap-3">
                    ...
                    <div class="d-flex gap-1">
                        <a href="{{ route('third', ['apps', 'ecommerce', 'product-grid']) }}"
                            class="btn btn-primary btn-icon">
                            <i data-lucide="layout-grid" class="fs-lg"></i>
                        </a>
                        <a href="{{ route('third', ['apps', 'ecommerce', 'products']) }}"
        ...
        <div class="col-xl-9">
                    ...
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Modern Minimalist Fabric Sofa Single Seater</a>
                            </h6>
                ...
                <div class="col">
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Funky Streetwear Sneakers - Neon Splash</a>
                            </h6>
                            ...
                            <div>
                                ...
                                <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                        class="link-reset fw-semibold">(32)</a></span>
                            </div>
                        </div>
                ...
                <div class="col">
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Noise Canceling Wireless Earbuds - Black Edition</a>
                            </h6>
                            ...
                            <div>
                                ...
                                <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                        class="link-reset fw-semibold">(58)</a></span>
                            </div>
                        </div>
                ...
                <div class="col">
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Minimalist Solid Wood Dining Chair</a>
                            </h6>
                            ...
                            <div>
                                ...
                                <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                        class="link-reset fw-semibold">(46)</a></span>
                            </div>
                        </div>
                ...
                <div class="col">
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Modern Black Minimalist Wall Clock</a>
                            </h6>
                            ...
                            <div>
                                ...
                                <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                        class="link-reset fw-semibold">(62)</a></span>
                            </div>
                        </div>
                ...
                <div class="col">
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Elegant Brown Wooden Chair</a>
                            </h6>
                            ...
                            <div>
                                ...
                                <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                        class="link-reset fw-semibold">(48)</a></span>
                            </div>
                        </div>
                ...
                <div class="col">
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Apple iMac 24" Retina 4.5K Display</a>
                            </h6>
                ...
                <div class="col">
                    <article class="card h-100 mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Coolest Ergonomic Lounge Chair</a>
                            </h6>
                ...
                <div class="col">
                    <article class="card h-100 mb-2 d-none d-lg-block d-xxl-none">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title fs-sm lh-base mb-2">
                                <a href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                    class="link-reset">Apple iPad 10.9" Wi-Fi 64GB - Silver</a>
                            </h6>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
                ...
                <ul class="pagination pagination-boxed mb-0 justify-content-center">
                    ...
                    <li class="page-item"><a href="#" class="page-link"><i class="ti ti-chevrons-right"></i></a>
                    </li>
                </ul>
            </div>
