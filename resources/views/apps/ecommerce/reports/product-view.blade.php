                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(54)</a></span>
                                </td>
                                <td>45.2k</td>
                                <td>820</td>
                                <td>7.3%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(31)</a></span>
                                </td>
                                <td>28.9k</td>
                                <td>410</td>
                                <td>5.8%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                    class="link-reset">Gaming Mouse</a></h5>
                                        </div>
                                    </div>
                                </td>
                                <td>GM-77215</td>
                                ...
                                <td>
                                    <span class="text-warning">
                                        <span class="ti ti-star-filled"></span><span
                                            class="ti ti-star-filled"></span><span class="ti ti-star-filled"></span><span
                                            class="ti ti-star-filled"></span><span class="ti ti-star"></span>
                                    </span>
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(67)</a></span>
                                </td>
                                <td>22.4k</td>
                                <td>340</td>
                                <td>6.4%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                    class="link-reset">Noise Cancelling
                                                    Headphones</a></h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="text-warning">
                                        <span class="ti ti-star-filled"></span><span
                                            class="ti ti-star-filled"></span><span class="ti ti-star-filled"></span><span
                                            class="ti ti-star-filled"></span><span class="ti ti-star-filled"></span>
                                    </span>
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(128)</a></span>
                                </td>
                                <td>60.1k</td>
                                <td>1500</td>
                                <td>9.8%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                    class="link-reset">4K Action Camera</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(94)</a></span>
                                </td>
                                <td>18.9k</td>
                                <td>610</td>
                                <td>6.0%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                    class="link-reset">Wireless Charger
                                                    Pad</a></h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="text-warning">
                                        <span class="ti ti-star-filled"></span><span
                                            class="ti ti-star-filled"></span><span class="ti ti-star-filled"></span><span
                                            class="ti ti-star"></span><span class="ti ti-star"></span>
                                    </span>
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(41)</a></span>
                                </td>
                                <td>12.3k</td>
                                <td>220</td>
                                <td>4.1%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(77)</a></span>
                                </td>
                                <td>30.5k</td>
                                <td>540</td>
                                <td>7.2%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                    class="link-reset">Drone with Camera</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(189)</a></span>
                                </td>
                                <td>75.9k</td>
                                <td>1900</td>
                                <td>10.2%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                    class="link-reset">Smart Home Hub</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(58)</a></span>
                                </td>
                                <td>21.7k</td>
                                <td>470</td>
                                <td>5.5%</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0"><a data-sort="product"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'product-details']) }}"
                                                    class="link-reset">Mini Projector</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            data-sort="rating" class="link-reset fw-semibold">(35)</a></span>
                                </td>
                                <td>15.9k</td>
                                <td>310</td>
                                <td>4.7%</td>
