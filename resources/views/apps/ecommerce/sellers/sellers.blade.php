                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a data-sort="seller"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'seller-details']) }}"
                                                    class="link-reset">GreenTech
                                                    Solutions</a>
                                            </h5>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a data-sort="rating"
                                            href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            class="link-reset fw-semibold">(4.5)</a></span>
                                </td>
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="/images/flags/ca.svg" alt="" class="rounded-circle me-1"
                                            height="12"> CA
                                    </span>
                                </td>
                                <td>$92.5k</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a data-sort="rating"
                                            href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            class="link-reset fw-semibold">(3)</a></span>
                                </td>
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a data-sort="rating"
                                            href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            class="link-reset fw-semibold">(3.5)</a></span>
                                </td>
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a data-sort="rating"
                                            href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            class="link-reset fw-semibold">(2)</a></span>
                                </td>
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a data-sort="seller"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'seller-details']) }}"
                                                    class="link-reset">TechMasters</a>
                                            </h5>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a data-sort="rating"
                                            href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            class="link-reset fw-semibold">(5)</a></span>
                                </td>
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a data-sort="seller"
                                                    href="{{ route('third', ['apps', 'ecommerce', 'seller-details']) }}"
                                                    class="link-reset">FutureGizmos</a>
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="/images/flags/br.svg" alt="" class="rounded-circle me-1"
                                            height="12"> BR
                                    </span>
                                </td>
                                <td>$125.4k</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="ms-1"><a data-sort="rating"
                                            href="{{ route('third', ['apps', 'ecommerce', 'review']) }}"
                                            class="link-reset fw-semibold">(4)</a></span>
                                </td>
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
