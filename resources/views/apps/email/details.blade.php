    ...
    <div class="outlook-box email-app">
        <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-sm" tabindex="-1"
            ...
            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                <div class="card-body">
                    <a href="{{ route('third', ['apps', 'email', 'compose']) }}"
                        class="btn btn-danger fw-medium w-100">Compose</a>

                    <div class="list-group list-group-flush list-custom mt-3">
                        <a href="{{ route('third', ['apps', 'email', 'inbox']) }}"
        ...
        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
            ...
            <div class="card-header card-bg justify-content-between">
                <div class="d-flex flex-wrap align-items-center gap-1">
                    <!-- Back to Inbox -->
                    <a href="{{ route('third', ['apps', 'email', 'inbox']) }}" class="btn btn-default btn-icon btn-sm"
                        data-bs-toggle="tooltip" title="Back to Inbox">
            ...
            <div class="card-body pt-0 pb-5" style="height: calc(100% - 100px);" data-simplebar data-simplebar-md>
                ...
                <div class="pb-3">
                    <div class="d-flex align-items-center">
                        <a class="d-flex align-items-center flex-grow-1 text-reset" data-bs-toggle="collapse"
                            href="#EmailOne" role="button" aria-expanded="false" aria-controls="EmailOne">
                ...
                <div class="py-3 border-top border-dashed">
                    <div class="d-flex align-items-center">
                        <a class="d-flex align-items-center flex-grow-1 text-reset" data-bs-toggle="collapse"
                            href="#EmailThree" role="button" aria-expanded="false" aria-controls="EmailThree">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-2 d-flex flex-wrap gap-2">
                                <div
                                    ...
                                    <div>
                                        <h4 class="fs-sm mb-1"><a href="#!"
                                                class="link-reset stretched-link">testimonial-glitch.mp4</a></h4>
                ...
                <div class="py-3 border-top border-dashed">
                    <div class="d-flex align-items-center">
                        <a class="d-flex align-items-center flex-grow-1 text-reset" data-bs-toggle="collapse"
                            href="#EmailTwo" role="button" aria-expanded="false" aria-controls="EmailTwo">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-2 d-flex flex-wrap gap-2">
                                <div
                                    ...
                                    <div>
                                        <h4 class="fs-sm mb-1"><a href="#!"
                                                class="link-reset stretched-link">footer-contrast-notes.pdf</a></h4>
                                ...
                                <div
                                    ...
                                    <div>
                                        <h4 class="fs-sm mb-1"><a href="#!"
                                                class="link-reset stretched-link">responsive-issues.png</a></h4>
                ...
                <div class="position-sticky bottom-0 z-1">
                    <div class="collapse" id="EmailReply">
                        <div class="mt-2 pb-5">
                            <textarea class="form-control rounded-top rounded-0" id="exampleFormControlTextarea1" rows="6"
                            ...
                            <div class="bg-light-subtle p-2 rounded-bottom border border-top-0">
                                <div class="d-flex gap-1 align-items-center">
                                    <button type="button" class="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-placement="top" title="Bold">
                                        <i class="ti ti-bold"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-placement="top" title="Italic">
                                        <i class="ti ti-italic"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-placement="top" title="Attach files">
                                        <i class="ti ti-paperclip"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-placement="top" title="Insert link">
                                        <i class="ti ti-link"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-light" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-placement="top" title="Insert photo">
                                        <i class="ti ti-photo-up"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-light ms-auto" data-bs-toggle="collapse"
                                        data-bs-target="#EmailReply">
            ...
            <div
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                        <button class="btn btn-sm btn-default" data-bs-toggle="collapse" data-bs-target="#EmailReply"
                            aria-expanded="false" aria-controls="EmailReply" type="button">
