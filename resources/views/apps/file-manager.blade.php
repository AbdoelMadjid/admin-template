...
@section('content')
    ...
    <div class="outlook-box outlook-box-full">
        <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-md" tabindex="-1"
                ...
                <div class="d-flex gap-2">
                    <div class="d-lg-none d-inline-flex gap-2">
                        <button class="btn btn-default btn-icon" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#fileSidebaroffcanvas" aria-controls="fileSidebaroffcanvas">
                            ...
                            <div class="card-body p-2">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        <a href="#" class="dropdown-toggle drop-arrow-none fs-xxl link-reset p-0"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="/images/users/user-1.jpg" download class="dropdown-item"><i
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#attex-react-folder"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-edit me-1"></i> Edit</a>
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#material-design"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-edit me-1"></i> Edit</a>
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#dashpro-ui"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-edit me-1"></i> Edit</a>
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#vuestudio-pack"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-edit me-1"></i> Edit</a>
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#nextify-pro"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-edit me-1"></i> Edit</a>
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#blazor-studio"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-edit me-1"></i> Edit</a>
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#angular-prime"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-edit me-1"></i> Edit</a>
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#react-kit-pro"><i class="ti ti-trash me-1"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base"><a data-sort="name" href="#!"
                                                    class="link-reset">Project
                                                    Overview Video</a></h5>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base"><a href="#!" data-sort="owner"
                                                class="link-reset">john@techgroup.com</a></h5>
                                    </div>
                                </td>
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-5.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-7.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-6.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-4.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                    </div>
                                </td>
                                <td class="text-end pe-3">
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        <span data-toggler="off">
                                            <a href="#" data-toggler-on class="d-none"><i
                                                    class="ti ti-star-filled text-warning fs-lg"></i></a>
                                            <a href="#" data-toggler-off><i
                                        ...
                                        <div class="dropdown flex-shrink-0 text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="#" class="dropdown-item"><i class="ti ti-pin me-1"></i>
                                                    Pin</a>
                                                <a href="#" class="dropdown-item"><i class="ti ti-edit me-1"></i>
                                                    Edit</a>
                                                <a href="#" data-table-delete-row class="dropdown-item"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base"><a href="#!" data-sort="owner"
                                                class="link-reset">michael@devteam.com</a></h5>
                                    </div>
                                </td>
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-2.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-3.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-5.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        ...
                                        <div class="dropdown flex-shrink-0 text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                <a href="/images/users/user-4.jpg" download class="dropdown-item"><i
                                                        class="ti ti-download me-1"></i>
                                                    Download</a>
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-pin me-1"></i> Pin</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base"><a data-sort="owner" href="#!"
                                                class="link-reset">susan@marketing.com</a></h5>
                                    </div>
                                </td>
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-1.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-3.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-6.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-9.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                    </div>
                                </td>
                                <td class="text-end pe-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base"><a data-sort="owner" href="#!"
                                                class="link-reset">mark@clientservices.com</a>
                                        </h5>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        ...
                                        <div class="dropdown flex-shrink-0 text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                <a href="/files/proposal.pdf" download class="dropdown-item"><i
                                                        class="ti ti-download me-1"></i>
                                                    Download</a>
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-pin me-1"></i> Pin</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base"><a href="#!" data-sort="owner"
                                                class="link-reset">alex@creatix.io</a>
                                        </h5>
                                    </div>
                                </td>
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-4.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                        <div class="avatar"><img src="/images/users/user-8.jpg" alt=""
                                                class="rounded-circle avatar-xs"></div>
                                    </div>
                                </td>
                                <td class="text-end pe-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        ...
                                        <div class="dropdown flex-shrink-0 text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                <a href="/files/dependency.dep" download class="dropdown-item"><i
                                                        class="ti ti-download me-1"></i>
                                                    Download</a>
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-pin me-1"></i> Pin</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base"><a data-sort="owner" href="#!"
                                                class="link-reset">emma@devcore.com</a>
                                        </h5>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        ...
                                        <div class="dropdown flex-shrink-0 text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                <a href="/images/users/user-6.jpg" download class="dropdown-item"><i
                                                        class="ti ti-download me-1"></i>
                                                    Download</a>
                                                <a href="javascript:void(0);" class="dropdown-item"><i
                                                        class="ti ti-pin me-1"></i> Pin</a>
