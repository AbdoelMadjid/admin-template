                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="dueDate" class="form-control" data-provider="flatpickr"
                                ...
                                <div class="table-responsive mt-4">
                                    ...
                                    <button type="button" class="btn btn-primary mt-2"><i class="ti ti-plus"></i> Add
                                        Item</button>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <table class="table table-borderless">
                                            ...
                                            <tr class="fw-bold">
                                                ...
                                                <td><input type="number" class="form-control" id="total" readonly
                                                        placeholder="0.00"></td>
                                            </tr>
                                        </table>
                                    </div>
                    ...
                    <div class="card card-top-sticky">
                        <div class="card-body">
                            <div class="justify-content-center d-flex flex-column gap-2">
                                <a href="javascript: void(0);" class="btn btn-light"><i class="ti ti-eye me-1"></i>
                                    Preview</a>
                                <a href="javascript: void(0);" class="btn btn-light"><i class="ti ti-download me-1"></i>
                                    Download</a>
                                <a href="javascript: void(0);" class="btn btn-danger btn-lg"><i
