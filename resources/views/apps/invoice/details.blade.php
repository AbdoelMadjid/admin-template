                    ...
                    <div class="card">
                        <div class="card-body px-4">
                            ...
                            <div class="mt-lg-4 mt-2 bg-light bg-opacity-50 rounded px-3 py-2">
                                <p class="mb-0 text-muted"><strong>Note:</strong> Please make payment within 10 days. For
                                    any billing inquiries, contact <a href="mailto:billing@alinadesignco.com"
                                        class="fw-medium">billing@alinadesignco.com</a>.</p>
                            </div>
