            ...
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('third', ['apps', 'invoice', 'create']) }}"
                            class="btn btn-purple rounded-circle btn-icon"><i class="ti ti-plus fs-lg"></i></a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        ...
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120010</a>
                                    </h5>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">Emily
                                                    Parker</a>
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        ...
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120009</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        ...
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120008</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        ...
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120007</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        <span class="ti ti-file-invoice text-success fs-lg"></span>
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120006</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        <span class="ti ti-file-invoice text-warning fs-lg"></span>
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120005</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        <span class="ti ti-file-invoice text-primary fs-lg"></span>
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120004</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        <span class="ti ti-file-invoice text-success fs-lg"></span>
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120003</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        <span class="ti ti-file-invoice text-warning fs-lg"></span>
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120002</a>
                                    </h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="m-0">
                                        <span class="ti ti-file-invoice text-danger fs-lg"></span>
                                        <a href="{{ route('third', ['apps', 'invoice', 'details']) }}"
                                            class="link-reset fw-semibold">#INS-0120001</a>
                                    </h5>
                                </td>
