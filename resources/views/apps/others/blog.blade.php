        ...
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">Building REST APIs
                            with Node.js</a>
                    </h6>
                    <p class="mb-3 text-muted">
                        Learn how to design and build scalable REST APIs with Node.js and Express in this step-by-step
                        tutorial.
                    </p>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">Web Design Trends
                            to Watch in 2025</a>
                    </h6>
                    <p class="mb-3 text-muted">
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card bg-primary bg-gradient rounded-3">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="text-white">Top Data Science
                            Trends in 2025</a>
                    </h6>
                    ...
                    <div>
                        <a href="#!" class="badge badge-label border rounded border-white border-opacity-25">Data
                            Science</a>
                        <a href="#!"
                            class="badge badge-label border rounded border-white border-opacity-25">Trends</a>
