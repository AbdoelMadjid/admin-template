                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name"
                            ...
                            <tr>
                                ...
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/mx.svg"
                                            alt="" class="rounded-circle me-1" height="12"> MX</span></td>
                                <td>Jan 8, 2024</td>
                                <td>Contract</td>
                            ...
                            <tr>
                                ...
                                <td>+65 6789 1234</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/sg.svg"
                                            alt="" class="rounded-circle me-1" height="12"> SG</span></td>
                                <td>Jan 30, 2024</td>
                                <td>Retainer</td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/jp.svg"
                                            alt="" class="rounded-circle me-1" height="12"> JP</span></td>
                                <td>Mar 5, 2024</td>
                                <td>Project</td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/br.svg"
                                            alt="" class="rounded-circle me-1" height="12"> BR</span></td>
                                <td>Feb 24, 2024</td>
                                <td>Contract</td>
