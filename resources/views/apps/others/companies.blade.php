            ...
            <div class="card d-flex flex-row p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>Seattle,
                            WA</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i
                                class="ti ti-shopping-cart me-1"></i>eCommerce</span>
                    </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>Cupertino,
                            CA</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i
                                class="ti ti-device-mobile me-1"></i>Tech</span>
                    </div>
                    <p class="text-muted mb-3">Apple Inc. designs, manufactures, and markets smartphones, personal
                        computers, tablets, and accessories.</p>
                    <div class="d-flex justify-content-between flex-wrap mt-2 gap-3">
                        <div>
                            <h6 class="text-muted">Employees</h6>
                        ...
                        <div class="text-warning align-self-center fs-lg">
                            <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i
                                class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i
                                class="ti ti-map-pin me-1"></i>Bentonville, AR</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i
                                class="ti ti-building-store me-1"></i>Retail</span>
                    </div>
                    <p class="text-muted mb-3">Walmart operates a chain of hypermarkets, discount department stores, and
                        grocery stores worldwide.</p>
                    <div class="d-flex justify-content-between flex-wrap mt-2 gap-3">
                        <div>
                            <h6 class="text-muted">Employees</h6>
                        ...
                        <div class="text-warning align-self-center fs-lg">
                            <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i
                                class="ti ti-star-filled"></i><i class="ti ti-star"></i><i class="ti ti-star"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card d-flex flex-row align-items-center p-3">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="https://www.starbucks.com"
                                class="text-muted text-decoration-none">www.starbucks.com</a>
                        </div>
                        <a href="#!" class="btn btn-sm btn-outline-danger rounded-pill">
                            <i class="ti ti-heart me-1"></i> Follow
                        </a>
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>Seattle,
                            WA</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i class="ti ti-coffee me-1"></i>Food &
                            Beverage</span>
                    </div>
                    <p class="text-muted mb-3">Starbucks is a multinational chain of coffeehouses and roastery reserves
                        headquartered in Seattle, Washington.</p>
                    <div class="d-flex justify-content-between flex-wrap mt-2 gap-3">
                        <div>
                            <h6 class="text-muted">Employees</h6>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row align-items-center p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>Menlo Park,
                            CA</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i class="ti ti-network me-1"></i>Tech</span>
                    </div>
                    <p class="text-muted mb-3">Meta develops social media platforms and technologies including Facebook,
                        Instagram, and the Metaverse.</p>
                    <div class="d-flex justify-content-between flex-wrap mt-2 gap-3">
                        <div>
                            <h6 class="text-muted">Employees</h6>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row align-items-center p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>Stockholm,
                            Sweden</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i
                                class="ti ti-music me-1"></i>Entertainment</span>
                    </div>
                    <p class="text-muted mb-3">Spotify is a digital music, podcast, and video streaming service with
                        millions of active users worldwide.</p>
                    <div class="d-flex justify-content-between flex-wrap mt-2 gap-3">
                        <div>
                            <h6 class="text-muted">Employees</h6>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row align-items-center p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>Mountain
                            View, CA</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i class="ti ti-world me-1"></i>Tech</span>
                    </div>
                    <p class="text-muted mb-3">Google specializes in internet-related services and products, including
                        search, ads, cloud, and more.</p>
                    <div class="d-flex justify-content-between flex-wrap mt-2 gap-3">
                        <div>
                            <h6 class="text-muted">Employees</h6>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row align-items-center p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>San
                            Francisco, CA</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i
                                class="ti ti-home me-1"></i>Hospitality</span>
                    </div>
                    <p class="text-muted mb-3">Airbnb is a global platform for lodging, primarily homestays for vacation
                        rentals and tourism activities.</p>
                    <div class="d-flex justify-content-between flex-wrap mt-2 gap-3">
                        <div>
                            <h6 class="text-muted">Employees</h6>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row align-items-center p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2 mb-3 d-flex flex-wrap gap-2">
                        <span class="badge bg-light text-primary p-1 fs-xxs"><i class="ti ti-map-pin me-1"></i>London,
                            UK</span>
                        <span class="badge bg-light text-success p-1 fs-xxs"><i
                                class="ti ti-gas-station me-1"></i>Energy</span>
                    </div>
                    <p class="text-muted mb-3">Shell is a global energy and petrochemical company focused on oil, gas, and
