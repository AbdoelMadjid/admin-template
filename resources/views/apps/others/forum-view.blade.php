                ...
                <div class="col-xl-9">
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            <div class="d-flex gap-4 align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="fs-lg mb-2">
                                        <a href="{{ route('third', ['apps', 'others', 'forum-post']) }}"
                                            class="link-reset">What's the best JavaScript framework in 2025?</a>
                                    </h4>

                                    <!-- Short Description -->
                                    <p class="text-muted mb-0">
                                        With so many frameworks available, developers often debate which one offers the best
                                        balance of performance, scalability, and ease of use. Share your thoughts!
                                    </p>
                                </div>
                            </div>
                        </div> <!-- end card-body-->
                        <div class="card-footer">
                            <p
                                class="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
                                ...
                                <span class="d-flex align-items-center gap-1"><span
                                        class="badge text-bg-success">New</span></span>
                            </p>
                        </div>
                    </div> <!-- end card -->
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            <div class="d-flex gap-4 align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="fs-lg mb-2">
                                        <a href="{{ route('third', ['apps', 'others', 'forum-post']) }}"
                                            class="link-reset">Should AI tools be regulated by governments?</a>
                                    </h4>
                                    <p class="text-muted mb-0">
                                        As AI becomes more powerful, discussions around ethics and control are growing.
                                        What’s your take on government involvement?
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <p
                                ...
                                <span class="d-flex align-items-center gap-1"><span
                                        class="badge text-bg-warning">23</span></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            <div class="d-flex gap-4 align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="fs-lg mb-2">
                                        <a href="{{ route('third', ['apps', 'others', 'forum-post']) }}"
                                            class="link-reset">Is minimalism still relevant in modern UI design?</a>
                                    </h4>
                                    <p class="text-muted mb-0">
                                        Clean interfaces have been a trend for years, but some argue they now lack
                                        innovation. What’s your opinion?
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <p
                                ...
                                <span class="d-flex align-items-center gap-1"><span
                                        class="badge text-bg-info">8</span></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            <div class="d-flex gap-4 align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="fs-lg mb-2">
                                        <a href="{{ route('third', ['apps', 'others', 'forum-post']) }}"
                                            class="link-reset">What’s better for growth: startups or large companies?</a>
                                    </h4>
                                    <p class="text-muted mb-0">
                                        Both have pros and cons—startups offer agility, while big companies provide
                                        stability. Which helped your career most?
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <p
                                ...
                                <span class="d-flex align-items-center gap-1"><span
                                        class="badge text-bg-primary">12</span></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            <div class="d-flex gap-4 align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="fs-lg mb-2">
                                        <a href="{{ route('third', ['apps', 'others', 'forum-post']) }}"
                                            class="link-reset">CI/CD or traditional release cycles: what works better?</a>
                                    </h4>
                                    <p class="text-muted mb-0">
                                        Continuous deployment speeds up delivery, but some teams prefer slower, stable
                                        releases. What’s your team's approach?
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <p
                                ...
                                <span class="d-flex align-items-center gap-1"><span
                                        class="badge text-bg-secondary">18</span></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex gap-4 align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="fs-lg mb-2">
                                        <a href="{{ route('third', ['apps', 'others', 'forum-post']) }}"
                                            class="link-reset">What’s the best way to start contributing to open
                                            source?</a>
                                    </h4>
                                    <p class="text-muted mb-0">
                                        Many developers want to join the open-source movement but don’t know where to begin.
                        ...
                        <div class="card-footer">
                            <p
                                ...
                                <span class="d-flex align-items-center gap-1"><span
                                        class="badge text-bg-dark">7</span></span>
                            </p>
                        </div>
                    </div>
