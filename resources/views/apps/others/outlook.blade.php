                ...
                <div class="tab-content">
                    <div class="tab-pane fade" id="outlook-tab-1" role="tabpanel">
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <div>
                                <button class="btn btn-default btn-sm" data-bs-toggle="tooltip" data-bs-placement="left"
                                    title="Plug this message">
                                    <i class="ti ti-plug me-1"></i> Plug it
                                </button>
                                <button class="btn btn-icon btn-default btn-sm" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Mark as read">
                                    <i class="ti ti-eye"></i>
                                </button>
                                <button class="btn btn-icon btn-default btn-sm" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Mark as important">
                                    <i class="ti ti-alert-circle"></i>
                                </button>
                                <button class="btn btn-icon btn-default btn-sm" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Move to trash">
                        ...
                        <p>
                            I hope you're well. I'm reaching out to explore a potential partnership between our teams. We've
                            been following your recent product launches and believe there's strong synergy between our
                            platforms.
                        </p>
                        <p>
                            We'd love to schedule a quick 30-minute call next week to discuss how we might collaborate on
                            upcoming campaigns. Please let me know what your availability looks like.
                        </p>
                        <p>
                    ...
                    <div class="tab-pane fade show active" id="outlook-tab-2" role="tabpanel">
                        ...
                        <p>
                            Thank you for sharing the latest draft of the landing page. The new layout looks clean and
                            intuitive, especially the improvements made to the hero section and the pricing table. I also
                            appreciated how responsive the mobile version feels.
                        </p>
                        <p>
                        ...
                        <p>
                            Once these changes are in place, we can finalize the QA pass and move on to staging. Let me know
                            if you need any additional assets or approvals on my end.
                        </p>
                    ...
                    <div class="tab-pane fade" id="outlook-tab-3" role="tabpanel">
                        ...
                        <p>
                            This is a gentle reminder that invoice <strong>#INV-1043</strong> for your March 2025
                            subscription will be due on <strong>April 22, 2025</strong>.
                        </p>
                        <p>
                            Kindly ensure the payment is processed before the due date to avoid any disruption of services.
                            You can view and pay the invoice via your account dashboard.
                        </p>
                        <p>
                    ...
                    <div class="tab-pane fade" id="outlook-tab-4" role="tabpanel">
                        ...
                        <p>
                            We hope you're enjoying your experience with TaskFlow Pro. We'd really appreciate it if you
                            could take 2 minutes to share your thoughts with us.
                        </p>
                        <p>
                            Your feedback helps us make TaskFlow better for everyone. Let us know what features you love and
                    ...
                    <div class="tab-pane fade" id="outlook-tab-5" role="tabpanel">
                        ...
                        <p>
                            We're pleased to inform you that your support ticket (#45782) regarding API rate limits has been
                            resolved.
                        </p>
                        <p>
                            The issue was caused by a misconfigured webhook, which we've now fixed on our end. Please feel
                            free to test your integration again.
                        </p>
                        <p>
                    ...
                    <div class="tab-pane fade" id="outlook-tab-6" role="tabpanel">
                        ...
                        <p>
                            I’ve attached the revised version of the partnership agreement we discussed during last week’s
                            call. Please take a moment to review and let me know if you'd like to propose any changes.
                        </p>
                        <p>
                    ...
                    <div class="tab-pane fade" id="outlook-tab-7" role="tabpanel">
                        ...
                        <p>
                            This is a reminder that your premium subscription to InsightPro will automatically renew on 20
                            April 2025.
                        </p>
                        <p>
                            If you wish to make changes to your billing or cancel your subscription, please visit your
