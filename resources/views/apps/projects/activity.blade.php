            ...
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-5.jpg" alt="" class="rounded-circle avatar-xxs"> Mia
                            Johnson
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-7.jpg" alt="" class="rounded-circle avatar-xxs"> Sophia
                            Martinez
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-8.jpg" alt="" class="rounded-circle avatar-xxs"> Jack
                            Wilson
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-10.jpg" alt="" class="rounded-circle avatar-xxs"> Benjamin
                            Taylor
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-2.jpg" alt="" class="rounded-circle avatar-xxs"> Ethan
                            Wong
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-3.jpg" alt="" class="rounded-circle avatar-xxs"> Grace
                            Kim
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-4.jpg" alt="" class="rounded-circle avatar-xxs"> Noah
                            Smith
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-6.jpg" alt="" class="rounded-circle avatar-xxs"> Liam
                            Davis
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-9.jpg" alt="" class="rounded-circle avatar-xxs"> Ella
                            Moore
                    ...
                    <div class="py-1 d-flex gap-3 align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}" class="link-reset fw-semibold">
                            <img src="/images/users/user-10.jpg" alt="" class="rounded-circle avatar-xxs">
                            Benjamin Taylor
                ...
                <div class="card-body">
                    ...
                    <div class="timeline timeline-icon-bordered">
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">New Feature Released <span
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-6.jpg" alt="Natalie Brooks"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Natalie Brooks</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">Team Sync-Up <span
                                            class="badge badge-label badge-soft-secondary ms-2">Meeting</span></h5>
                                    <span class="text-muted fs-xs">Today at 2:00 PM</span>
                                </div>
                                <p class="mb-1 text-muted">Reviewed sprint progress and discussed remaining tasks with the
                                    dev team.</p>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-4.jpg" alt="Oliver Grant"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Oliver Grant</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">UI Design Review <span
                                            class="badge badge-label badge-soft-success ms-2">Design</span></h5>
                                    <span class="text-muted fs-xs">Today at 1:15 PM</span>
                                </div>
                                <p class="mb-1 text-muted">Updated component spacing and colors for improved accessibility.
                                </p>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-9.jpg" alt="Clara Jensen"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Clara Jensen</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">Database Optimization <span
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-10.jpg" alt="Leo Armstrong"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Leo Armstrong</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">Security Audit Completed <span
                                            class="badge badge-label badge-soft-warning ms-2">Audit</span></h5>
                                    <span class="text-muted fs-xs">Today at 11:00 AM</span>
                                </div>
                                <p class="mb-1 text-muted">Completed internal security audit with no critical issues found.
                                </p>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-8.jpg" alt="Liam Carter"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Liam Carter</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">New Team Member Joined <span
                                ...
                                <p class="mb-1 text-muted">Michael Lee has joined the development team as a Frontend
                                    Engineer.</p>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-7.jpg" alt="Emma Davis"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Emma Davis</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">Documentation Updated <span
                                            class="badge badge-label badge-soft-secondary ms-2">Docs</span></h5>
                                    <span class="text-muted fs-xs">Yesterday at 5:20 PM</span>
                                </div>
                                <p class="mb-1 text-muted">Refreshed developer documentation with updated APIs and
                                    workflows.</p>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-7.jpg" alt="Sophia Reed"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Sophia Reed</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">Task Completed <span
                                            class="badge badge-label badge-soft-success ms-2">Done</span></h5>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <img src="/images/users/user-5.jpg" alt="Daniel Chen"
                                        class="rounded-circle avatar-xxs">
                                    <a href="{{ route('second', ['pages', 'profile']) }}"
                                        class="fw-semibold link-reset">Daniel Chen</a>
                                </div>
                            </div>
                        </div>
