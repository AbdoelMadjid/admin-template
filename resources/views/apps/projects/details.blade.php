                ...
                <div class="col-xl-9">
                    <div class="card card-h-100 rounded-0 rounded-start">
                        <div class="card-header align-items-start p-4">
                            ...
                            <div class="ms-auto">
                                <a href="javascript: void(0);" class="btn btn-light"><i class="ti ti-pencil me-1"></i>
                                    Edit</a>
                            </div>
                        </div>
                        <div class="card-body px-4">
                            <div class="mb-4">
                                ...
                                <p class="text-muted">
                                    Customizable reports and role-based dashboards ensure relevant insights for marketing
                                    teams, financial analysts, and executive decision-makers. The system is built with
                                    scalability and responsiveness in mind, supporting both desktop and mobile views for
                                    seamless access.
                                </p>
                            </div>
                            <div class="row mb-4">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="comments" role="tabpanel">
                                    <form action="#" class="mb-3">
                                        ...
                                        <div class="text-end">
                                            <button type="submit" class="btn btn-secondary btn-sm">Comment <i
                                                    class="ti ti-send-2 align-baseline ms-1"></i></button>
                                        </div>
                                    </form>
                                    ...
                                    <div class="d-flex mb-2 border border-dashed rounded p-3">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <h5 class="mb-1">Liam Carter <small class="text-muted">15 Apr 2025 ·
                                                    09:20AM</small></h5>
                                            <p class="mb-2">Customers are reporting that the checkout page freezes after
                                                submitting their payment information.</p>
                                            ...
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h5 class="mb-1">Nina Bryant <small class="text-muted">15 Apr 2025 ·
                                                            11:47AM</small></h5>
                                                    <p class="mb-2">That might be caused by the third-party payment
                                                        gateway. I recommend testing in incognito mode and checking for any
                                                        JS errors in the console.</p>
                                                    <a href="javascript:void(0);"
                                                        class="badge bg-light text-muted d-inline-flex align-items-center gap-1">
                                                        <i class="ti ti-arrow-back-up fs-lg"></i> Reply
                                                    </a>
                                            ...
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h5 class="mb-1">Sophie Allen <small class="text-muted">16 Apr 2025
                                                            · 10:15AM</small></h5>
                                                    <p class="mb-2">We’ve noticed this issue before when the CDN cache
                                                        hasn't been cleared properly. Try purging the cache and reloading
                                                        the page.</p>
                                                    <a href="javascript:void(0);"
                                                        class="badge bg-light text-muted d-inline-flex align-items-center gap-1">
                                                        <i class="ti ti-arrow-back-up fs-lg"></i> Reply
                                    ...
                                    <div class="d-flex mb-2 border border-dashed rounded p-3">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <h5 class="mb-1">Daniel West <small class="text-muted">14 Apr 2025 ·
                                                    04:15PM</small></h5>
                                            <p class="mb-2">You can also clear the browser cache or try a different
                                                browser. We had a similar issue with Chrome extensions interfering before.
                                            </p>
                                            <a href="javascript:void(0);"
                                                class="badge bg-light text-muted d-inline-flex align-items-center gap-1">
                                                <i class="ti ti-arrow-back-up fs-lg"></i> Reply
                                    ...
                                    <div class="d-flex mb-3 border border-dashed rounded p-3">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <h5 class="mb-1">Nina Bryant <small class="text-muted">16 Apr 2025 ·
                                                    08:04AM</small></h5>
                                            <p>The <a href="javascript:void(0)" class="text-decoration-underline">System
                                                    Status Page</a> has been updated. We're actively monitoring and will
                                                release a patch within 24 hours.</p>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <a href="#!" data-bs-toggle="offcanvas" role="button"
                                                            class="link-reset fw-medium">Finalize monthly performance
                                                            report</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap mb-0 lh-base"><a
                                                                        href="{{ route('second', ['pages', 'profile']) }}"
                                                                        class="link-reset">Liam James</a></h5>
                                                            </div>
                                                        </div>

                                                        <div class="flex-shrink-0">
                                                            <span
                                                                class="badge text-bg-success badge-label">Completed</span>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox"
                                                            ...
                                                            id="task3">
                                                        <a href="#!" data-bs-toggle="offcanvas" role="button"
                                                            class="link-reset fw-medium">Design wireframes for new
                                                            onboarding flow</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap mb-0 lh-base"><a
                                                                        href="{{ route('second', ['pages', 'profile']) }}"
                                                                        class="link-reset">Sophia Lee</a></h5>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox"
                                                            ...
                                                            id="task4">
                                                        <a href="#!" data-bs-toggle="offcanvas" role="button"
                                                            class="link-reset fw-medium">Update customer segmentation
                                                            dashboard</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap mb-0 lh-base"><a
                                                                        href="{{ route('second', ['pages', 'profile']) }}"
                                                                        class="link-reset">Noah Carter</a></h5>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox"
                                                            ...
                                                            id="task5">
                                                        <a href="#!" data-bs-toggle="offcanvas" role="button"
                                                            class="link-reset fw-medium">Conduct competitor analysis
                                                            report</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap mb-0 lh-base"><a
                                                                        href="{{ route('second', ['pages', 'profile']) }}"
                                                                        class="link-reset">Emily Davis</a></h5>
                                                            </div>
                                                        </div>

                                                        <div class="flex-shrink-0">
                                                            <span class="badge text-bg-warning badge-label">In
                                                                Progress</span>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox"
                                                            ...
                                                            id="task6">
                                                        <a href="#!" data-bs-toggle="offcanvas" role="button"
                                                            class="link-reset fw-medium">Implement API for mobile
                                                            integration</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap mb-0 lh-base"><a
                                                                        href="{{ route('second', ['pages', 'profile']) }}"
                                                                        class="link-reset">Lucas White</a></h5>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox"
                                                            ...
                                                            id="task7">
                                                        <a href="#!" data-bs-toggle="offcanvas" role="button"
                                                            class="link-reset fw-medium">QA testing for billing module</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap mb-0 lh-base"><a
                                                                        href="{{ route('second', ['pages', 'profile']) }}"
                                                                        class="link-reset">Olivia Martin</a></h5>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox"
                                                            ...
                                                            id="task8">
                                                        <a href="#!" data-bs-toggle="offcanvas" role="button"
                                                            class="link-reset fw-medium">Schedule product roadmap
                                                            presentation</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap mb-0 lh-base"><a
                                                                        href="{{ route('second', ['pages', 'profile']) }}"
                                                                        class="link-reset">Ethan Moore</a></h5>
                                                            </div>
                                                        </div>

                                                        <div class="flex-shrink-0">
                                                            <span
                                                                class="badge text-bg-secondary badge-label">Planned</span>
                                                        </div>
                                ...
                                <div class="tab-pane fade" id="activity" role="tabpanel">
                                    ...
                                    <div class="d-flex gap-1 border-bottom border-dashed pb-3">
                                        ...
                                        <div class="flex-grow-1 text-muted">
                                            <span class="fw-medium text-body">Daniel Martinez</span> uploaded a revised
                                            contract file.
                                    ...
                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                        <div class="me-2 flex-shrink-0">
                                            <img src="/images/users/user-2.jpg" class="avatar-md rounded-circle"
                                                alt="">
                                        </div>
                                        <div class="flex-grow-1 text-muted">
                                            <span class="fw-medium text-body">Nina Patel</span> commented on your design
                                            update.
                                    ...
                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                        ...
                                        <div class="flex-grow-1 text-muted">
                                            <span class="fw-medium text-body">Jason Lee</span> completed the feedback
                                            review.
                                    ...
                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                        ...
                                        <div class="flex-grow-1 text-muted">
                                            <span class="fw-medium text-body">Emma Davis</span> shared a link in the
                                            marketing group chat.
                                            <p class="fs-xs mb-2 text-body-secondary">Yesterday 3:25 pm - 23 Apr, 2025</p>
                                            <a href="#!" class="btn btn-default border px-1 py-0"><i
                                                    class="ti ti-link me-1"></i> View</a>
                                        </div>
                                    ...
                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                        <div class="me-2 flex-shrink-0">
                                            <img src="/images/users/user-5.jpg" class="avatar-md rounded-circle"
                                                alt="">
                                        </div>
                                        <div class="flex-grow-1 text-muted position-relative">
                                            ...
                                            <div class="py-2 px-3 bg-light bg-opacity-50">
                                                "Let’s sync up on the product roadmap tomorrow afternoon, does 2 PM work for
                                                you?"
                                            </div>
                                        </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-3 border-bottom border-dashed">
                                <div class="d-flex mb-3 justify-content-between align-items-center">
                                    ...
                                    <a href="javascript: void(0);" class="btn btn-light btn-sm btn-icon rounded-circle"><i
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base"><a
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">Ava Brooks</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base"><a
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">Liam Carter</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base"><a
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">Noah Kim</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base"><a
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">Emma Watson</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base"><a
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">James Nolan</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base"><a
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">Olivia Reed</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap mb-0 lh-base"><a
                                                    href="{{ route('second', ['pages', 'profile']) }}"
                                                    class="link-reset">Daniel Craig</a></h5>
                            ...
                            <div class="px-3 pt-3 border-bottom border-dashed">
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base"><a href="#!"
                                                    class="link-reset">Project-Brief.pdf</a></h5>
                                            <p class="text-muted mb-0 fs-xs">2.1MB</p>
                                        </div>
                                    </div>
                                    <div>
                                        <a href="#" class="btn btn-sm btn-icon btn-default" title="Download"><i
                                                class="ti ti-download fs-lg"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base"><a href="#!"
                                                    class="link-reset">Team-Intro.mp3</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base"><a href="#!" class="link-reset">UI-Kit.zip</a>
                                            </h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base"><a href="#!"
                                                    class="link-reset">Brand-Logo.png</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base"><a href="#!"
                                                    class="link-reset">Promo-Video.mp4</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <div class="d-flex align-items-center py-1 gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base"><a href="#!"
                                                    class="link-reset">dashboard-config.json</a></h5>
