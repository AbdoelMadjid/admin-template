                ...
                <div class="row gap-3">
                    ...
                    <div class="col-auto">
                        <div class="d-flex gap-1">
                            ...
                            <a href="{{ route('third', ['apps', 'projects', 'list']) }}"
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ route('third', ['apps', 'projects', 'details']) }}" class="link-reset">AI
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ route('third', ['apps', 'projects', 'details']) }}"
                                    class="link-reset">Marketing Automation Platform</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ route('third', ['apps', 'projects', 'details']) }}" class="link-reset">Website
                                    Redesign</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ route('third', ['apps', 'projects', 'details']) }}" class="link-reset">Sales
                                    Insight Tool</a>
                            </h5>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <i class="ti ti-list-check text-muted fs-lg"></i>
                                <h5 class="fs-base mb-0 fw-medium">12/50 <span class="badge bg-secondary">+2 New</span>
                                </h5>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="avatar-group avatar-group-xs mb-3">
                        ...
                        <div class="avatar"><img src="/images/users/user-4.jpg" class="rounded-circle avatar-xs"
                                alt=""></div>
                        <div class="avatar"><img src="/images/users/user-5.jpg" class="rounded-circle avatar-xs"
                                alt=""></div>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-header bg-light-subtle border-light p-3">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ route('third', ['apps', 'projects', 'details']) }}" class="link-reset">Cyber
                                Security System</a>
                        </h5>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <i class="ti ti-list-check text-muted fs-lg"></i>
                                <h5 class="fs-base mb-0 fw-medium">28/40 <span class="badge bg-secondary">+4 New</span>
                                </h5>
                            </div>
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-header bg-light-subtle border-light p-3">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ route('third', ['apps', 'projects', 'details']) }}" class="link-reset">Cloud Sync
                                Platform</a>
                        </h5>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-header bg-light-subtle border-light p-3">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ route('third', ['apps', 'projects', 'details']) }}" class="link-reset">Data Mining
                                Toolkit</a>
                        </h5>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <i class="ti ti-list-check text-muted fs-lg"></i>
                                <h5 class="fs-base mb-0 fw-medium">7/25 <span class="badge bg-secondary">+2 New</span>
                                </h5>
                            </div>
                        </div>
                        <div class="col-sm-6">
