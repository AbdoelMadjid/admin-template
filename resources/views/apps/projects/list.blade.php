                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project"
                                                    href="{{ route('third', ['apps', 'projects', 'details']) }}"
                                                    class="link-reset">AI Analytics
                                                    Dashboard</a>
                                            </h5>
                                ...
                                <td>
                                    <h5 class="fs-base mb-0 fw-medium">18/60 <span class="badge bg-secondary">+4 New</span>
                                    </h5>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-6.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-8.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-7.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project"
                                                    href="{{ route('third', ['apps', 'projects', 'details']) }}"
                                                    class="link-reset">UI Kit Design</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-4.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-2.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-7.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-9.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                    </div>
                                </td>
                                <td><span class="badge badge-soft-info fs-xxs badge-label">In Review</span></td>
                                <td>
                                    <h5 class="fs-base mb-0 fw-medium">15/30 <span class="badge bg-secondary">+1
                                            New</span></h5>
                                </td>
                                <td>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-5.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-10.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-8.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-2.jpg"
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-soft-info fs-xxs badge-label">In Review</span></td>
                                <td>
                                    <h5 class="fs-base mb-0 fw-medium">9/12 <span class="badge bg-secondary">+1 New</span>
                                    </h5>
                                </td>
                                <td>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        ...
                                        <div class="avatar"><img src="/images/users/user-5.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                        <div class="avatar"><img src="/images/users/user-1.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                    </div>
                                </td>
                                <td><span class="badge badge-soft-success fs-xxs badge-label">In Progress</span></td>
                                <td>
                                    <h5 class="fs-base mb-0 fw-medium">6/10 <span class="badge bg-secondary">+3 New</span>
                                    </h5>
                                </td>
                                <td>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project"
                                                    href="{{ route('third', ['apps', 'projects', 'details']) }}"
                                                    class="link-reset">Security Audit</a>
                                            </h5>
                                ...
                                <td>
                                    <h5 class="fs-base mb-0 fw-medium">5/10 <span class="badge bg-secondary">+1 New</span>
                                    </h5>
                                </td>
                                <td>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar"><img src="/images/users/user-3.jpg"
                                                class="rounded-circle avatar-xs" alt="user-img"></div>
                                    </div>
                                </td>
                                <td><span class="badge badge-soft-warning fs-xxs badge-label">Pending</span></td>
                                <td>
                                    <h5 class="fs-base mb-0 fw-medium">2/6 <span class="badge bg-secondary">+1 New</span>
                                    </h5>
                                </td>
                                <td>
                                    <div class="progress" style="height: 5px;">
