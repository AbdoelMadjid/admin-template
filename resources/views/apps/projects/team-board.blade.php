                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h4 class="card-title">IT-01 - Design Team <span
                                    class="ms-2 badge badge-label text-bg-primary">New</span></h4>
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-muted">The Design Team focuses on creating intuitive user experiences and
                                    visually appealing interfaces. We handle UI/UX design, prototyping, and brand
                                    consistency across all digital products.</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="mb-3">
                                <h5 class="fs-base mb-2">About Team:</h5>
                                <p class="text-muted">The Development Team builds and maintains core product features,
                                    ensuring robust performance, scalability, and code quality across all platforms. We
                                    specialize in full-stack development and agile delivery.</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="avatar-group avatar-group-sm mb-3">
                                <div class="avatar"><img src="/images/users/user-10.jpg" alt=""
                                        class="rounded-circle avatar-sm"></div>
                            ...
                            <div class="mb-3">
                                <h5 class="fs-base mb-2">About Team:</h5>
                                <p class="text-muted">The Administrator Team manages system settings, user roles,
                                    permissions, and ensures data security and compliance across platforms.</p>
                            </div>
                            <div class="row">
                                <div class="col-xl-4 col-md-6">
                                    <div class="d-flex gap-2 mb-3 mb-xl-0">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="mb-3">
                                <h5 class="fs-base mb-2">About Team:</h5>
                                <p class="text-muted">The Finance Team handles budgeting, forecasts, and financial
                                    analysis. We ensure transparency and strategic alignment with business goals.</p>
                            </div>
                            <div class="row">
                                <div class="col-xl-4 col-md-6">
                                    <div class="d-flex gap-2 mb-3 mb-xl-0">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="mb-3">
                                <h5 class="fs-base mb-2">About Team:</h5>
                                <p class="text-muted">The Marketing Team manages branding, campaigns, and audience
                                    engagement. We drive growth through creative storytelling and data-driven strategies.
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-xl-4 col-md-6">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="mb-3">
                                <h5 class="fs-base mb-2">About Team:</h5>
                                <p class="text-muted">The Graphic Team brings visual concepts to life. We handle
                                    illustrations, digital , brand collateral, and motion graphics to support product and
                                    marketing teams.</p>
                            </div>
