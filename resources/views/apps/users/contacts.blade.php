                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 position-relative">
                            <img src="/images/users/user-5.jpg" alt="avatar" class="rounded-circle" width="72"
                                height="72">
                            <span class="position-absolute bottom-0 end-0 badge bg-warning rounded-circle p-1 shadow-sm"
                                title="Rating 4.8">
                        ...
                        <div class="ms-auto">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="#"><i class="ti ti-share me-2"></i>Share</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i class="ti ti-edit me-2"></i>Edit</a></li>
                                    <li><a class="dropdown-item" href="#"><i class="ti ti-ban me-2"></i>Block</a>
                                    </li>
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">sophia@designhub.com</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#" class="link-reset">+44 7911
                                        123456</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('second', ['pages', 'profile']) }}"
                            class="btn btn-soft-primary btn-sm rounded-pill">View Profile</a>
                    </div>
                </div>
            </div>
        </div> <!-- end col-->
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 position-relative">
                            <img src="/images/users/user-6.jpg" alt="avatar" class="rounded-circle" width="72"
                                height="72">
                            <span class="position-absolute bottom-0 end-0 badge bg-success rounded-circle p-1 shadow-sm"
                                title="Rating 4.5">
                                <i class="ti ti-star text-white"></i>
                            </span>
                        </div>
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                ...
                                <img src="/images/flags/us.svg" alt="US" class="ms-2 rounded-circle"
                                    height="16">
                            </h5>
                        ...
                        <div class="ms-auto">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="#"><i class="ti ti-edit me-2"></i>Edit</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i class="ti ti-ban me-2"></i>Block</a>
                                    </li>
                                    <li><a class="dropdown-item text-danger" href="#"><i
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-xs avatar-img-size fs-24">
                                    <span class="avatar-title text-bg-light fs-sm rounded-circle"><i
                                            class="ti ti-mail"></i></span>
                                </div>
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">marcus@devhub.com</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#" class="link-reset">+1
                                        408-222-9876</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 position-relative">
                            <img src="/images/users/user-7.jpg" alt="avatar" class="rounded-circle" width="72"
                                height="72">
                            <span class="position-absolute bottom-0 end-0 badge bg-danger rounded-circle p-1 shadow-sm"
                                title="Rating 3.9">
                                <i class="ti ti-star text-white"></i>
                            </span>
                        </div>
                        <div>
                            <h5 class="mb-1 "><a href="{{ route('second', ['pages', 'profile']) }}"
                                    class="link-reset">Emily Davis</a> <img src="/images/flags/us.svg" alt="US"
                                    class="ms-2 rounded-circle" height="16"></h5>
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">emily@marketboost.com</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 position-relative">
                            <img src="/images/users/user-8.jpg" alt="avatar" class="rounded-circle" width="72"
                                height="72">
                            <span class="position-absolute bottom-0 end-0 badge bg-info rounded-circle p-1 shadow-sm"
                                title="Rating 4.3">
                                <i class="ti ti-star text-white"></i>
                            </span>
                        </div>
                        <div>
                            <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile']) }}"
                                    class="link-reset">Daniel Smith</a> <img src="/images/flags/ca.svg" alt="US"
                                    class="ms-2 rounded-circle" height="16"></h5>
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">daniel@analyticspro.io</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
            ...
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                ...
                                <img src="/images/flags/us.svg" alt="USA" class="ms-2 rounded-circle"
                                    height="16">
                            </h5>
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">daniel@projecthub.io</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#" class="link-reset">+1 212 555
                                        7890</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-muted fs-xs"><i class="ti ti-refresh me-1"></i>Updated 1 hour ago</span>
                        <a href="{{ route('second', ['pages', 'profile']) }}"
                            class="btn btn-soft-success btn-sm rounded-pill">View Profile</a>
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 position-relative">
                            <img src="/images/users/user-4.jpg" alt="avatar" class="rounded-circle" width="72"
                                height="72">
                            <span class="position-absolute bottom-0 end-0 badge bg-success rounded-circle p-1 shadow-sm"
                                title="Rating 4.8">
                                <i class="ti ti-star text-white"></i>
                        ...
                        <div>
                            <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile']) }}"
                                    class="link-reset">Jessica Chen</a> <img src="/images/flags/cn.svg" alt="CN"
                                    class="ms-2 rounded-circle" height="16"></h5>
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">jessica@uxstudio.cn</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#" class="link-reset">+86
                                        10-1234-5678</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
            ...
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile']) }}"
                                    class="link-reset">Arjun Patel</a> <img src="/images/flags/in.svg" alt="IN"
                                    class="ms-2 rounded-circle" height="16"></h5>
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">arjun@techflow.in</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#" class="link-reset">+91
                                        98765-43210</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
            ...
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile']) }}"
                                    class="link-reset">Olivia Garcia</a> <img src="/images/flags/es.svg" alt="ES"
                                    class="ms-2 rounded-circle" height="16"></h5>
                    ...
                    <ul class="list-unstyled text-muted mb-4">
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                        class="link-reset">olivia@contentwave.es</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="fs-base mb-0 fw-medium"><a href="#" class="link-reset">+34 912 345
                                        678</a></h5>
                            </div>
                        </li>
                        <li class="mb-2">
