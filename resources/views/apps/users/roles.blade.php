                    ...
                    <div class="card">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-xl rounded-circle bg-success-subtle d-flex align-items-center justify-content-center">
                            ...
                            <div class="avatar-group avatar-group-sm mb-3">
                                <div class="avatar"><img src="/images/users/user-2.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-5.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-6.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-1.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-8.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                            </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="avatar-group avatar-group-sm mb-3">
                                <div class="avatar"><img src="/images/users/user-3.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-4.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-9.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-10.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                    ...
                    <div class="card">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="avatar-group avatar-group-sm mb-3">
                                ...
                                <div class="avatar"><img src="/images/users/user-5.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                                <div class="avatar"><img src="/images/users/user-7.jpg" class="rounded-circle avatar-sm"
                                        alt=""></div>
                            </div>
                            ...
                            <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-5.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Nathan
                                                            Young</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-3.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Leah
                                                            Kim</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-1.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Sophie
                                                            Lee</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-2.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">David
                                                            Tran</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-4.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Isabella
                                                            Moore</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-6.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Daniel
                                                            Cooper</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-8.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Ava
                                                            Thompson</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-9.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Mason
                                                            Carter</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar avatar-sm"><img src="/images/users/user-10.jpg"
                                                        class="img-fluid rounded-circle" alt=""></div>
                                                <div>
                                                    <h5 class="fs-base mb-0"><a data-sort="user" href="#"
                                                            class="link-reset">Chloe
                                                            Adams</a></h5>
