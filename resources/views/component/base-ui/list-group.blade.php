                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold"
                            href="https://getbootstrap.com/docs/5.3/components/list-group/" target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item"><i
                                    class="ti ti-device-desktop-analytics me-1 align-middle fs-xl"></i> Zendesk Customer
                                Support</li>
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item active"><i class="ti ti-brand-github me-1 align-middle fs-xl"></i>
                                GitHub Repository</li>
                            <li class="list-group-item"><i class="ti ti-brand-figma me-1 align-middle fs-xl"></i> Figma
                                Design Tool</li>
                            <li class="list-group-item"><i class="ti ti-brand-notion me-1 align-middle fs-xl"></i> Notion
                                Workspace</li>
                            <li class="list-group-item"><i class="ti ti-brand-trello me-1 align-middle fs-xl"></i> Trello
                                Task Manager</li>
                            <li class="list-group-item"><i class="ti ti-cloud me-1 align-middle fs-xl"></i> DigitalOcean
                                Cloud</li>
                        </ul>
