        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/toasts/"
                            target="_blank">
                            Toasts on Bootstrap
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Click the button below to show a toast (positioned with our utilities in the
                            Toop Right corner)
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="toast show align-items-center mb-2" role="alert" aria-live="assertive"
                            aria-atomic="true">
                            <div class="d-flex">
                                <div class="toast-body">
                                    Hello, world! This is a toast message.
