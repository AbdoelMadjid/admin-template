        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold"
                            href="https://getbootstrap.com/docs/5.3/components/placeholders/" target="_blank">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            Customize them with sizing modifiers: <code>.placeholder-lg</code>,
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            <code>.col-6</code>) to set the <code>width</code>. They can replace the text inside an element
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            Animate placehodlers with <code>.placeholder-glow</code> or <code>.placeholder-wave</code> to
