        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/popovers/"
                            target="_blank">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Need Help?"
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" tabindex="0" class="btn btn-primary" data-bs-toggle="popover"
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button" class="btn btn-purple" data-bs-toggle="popover"
                                data-bs-placement="right" data-bs-custom-class="popover-purple"
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <span class="d-inline-block" data-bs-toggle="popover" data-bs-placement="top"
