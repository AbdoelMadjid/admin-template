        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/progress/"
                            target="_blank">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">A progress bar can be used to show a user how far along he/she is in a
                            process.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">We only set a <code>height</code> value on the <code>.progress</code>, so if
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress" role="progressbar" aria-label="Example with label" aria-valuenow="10"
                            ...
                            <div class="progress-bar overflow-visible text-dark" style="width: 10%">Long label text for
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Use background utility classes to change the appearance of individual
                            progress bars.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to
