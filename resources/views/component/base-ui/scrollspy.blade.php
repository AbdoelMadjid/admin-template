            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/scrollspy/"
                            target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown"
                                        href="#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <i
                        ...
                        <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                            style="height: 200px;" class="overflow-auto mt-2 position-relative">
                            <h4 id="fat">@fat</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-offset="0"
                                    style="height: 300px;" class="overflow-auto mt-2 position-relative">
                                    <h4 id="item-1">Item 1</h4>
