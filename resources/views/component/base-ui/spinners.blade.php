        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">
                            Indicate the loading state of a component or page with Bootstrap spinners, built entirely with
                            HTML, CSS, and no JavaScript.
                        </p>

                        <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/spinners/"
                            target="_blank">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Use text color utilities like <code>.text-primary</code>,
                            <code>.text-success</code>, or <code>.text-danger</code> to style the spinner, which inherits
                            its color from <code>currentColor</code>.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">The grow spinner also uses <code>currentColor</code>, so apply classes like
                            <code>.text-primary</code>, <code>.text-warning</code>, or <code>.text-info</code> to customize
                            its color.</p>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="flex-grow-1">
                            <h4 class="card-title">SpinKit <span class="badge badge-soft-warning">CSS Based Plugin</span>
                            </h4>
                        </div>
                        <div class="card-action">
                            <a href="https://tobiasahlin.com/spinkit/" target="_blank" class="card-action-item"><i
