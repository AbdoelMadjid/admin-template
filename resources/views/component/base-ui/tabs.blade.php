        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-action">
                            ...
                            <a href="#!" class="card-action-item" data-action="code-collapse"><i
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                <p class="mb-0">
                                    ...
                                    privacy controls.
                                    Adjust layout configurations to suit your workflow and manage integration with
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="projects1">
                                <p class="mb-0">
                                    View and manage all ongoing projects, tasks, and milestones. Collaborate with your team
                                    and track progress
                                    in real-time.
                                </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3 mb-2 mb-sm-0">
                                <div class="nav flex-column nav-pills" id="v-pills-tab1" role="tablist"
                                    ...
                                    <a class="nav-link fw-semibold active show" id="v-pills-home-tab"
                                        data-bs-toggle="pill" href="#v-pills-home" role="tab"
                                        aria-controls="v-pills-home" aria-selected="true">
                                        Overview
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-profile-tab" data-bs-toggle="pill"
                                        href="#v-pills-profile" role="tab" aria-controls="v-pills-profile"
                                        aria-selected="false">
                                        Profile
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-settings-tab" data-bs-toggle="pill"
                                        href="#v-pills-settings" role="tab" aria-controls="v-pills-settings"
                                        aria-selected="false">
                                        Settings
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-projects-tab" data-bs-toggle="pill"
                                        href="#v-pills-projects" role="tab" aria-controls="v-pills-projects"
                                        aria-selected="false">
                                        Projects
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-support-tab" data-bs-toggle="pill"
                            ...
                            <div class="col-sm-9">
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade active show" id="v-pills-home" role="tabpanel"
                                        ...
                                        <p class="mb-0">Your dashboard is tailored to your activity and roles. Stay
                                            informed and always one step ahead.</p>
                                    </div>

                                    <!-- Profile Tab -->
                                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                        aria-labelledby="v-pills-profile-tab">
                                        <p class="mb-2">Manage your personal details, change your profile photo, and
                                    ...
                                    <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                                        ...
                                        <p class="mb-0">Settings help personalize your interface and improve your
                                    ...
                                    <div class="tab-pane fade" id="v-pills-projects" role="tabpanel"
                                        ...
                                        <p class="mb-0">Use collaboration tools, upload documents, and manage
                                            deliverables directly from here.</p>
                                    </div>

                                    <!-- Support Tab -->
                                    <div class="tab-pane fade" id="v-pills-support" role="tabpanel"
                                        aria-labelledby="v-pills-support-tab">
                                        <p class="mb-2">Need assistance? Access our help center or contact our support
                                            team directly.</p>
                                        <ul>
            ...
            <div class="col-xxl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            You can add the <code>.nav-pills-*</code> class to the <code>.nav</code> element to apply
                            colored pill styles.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="tab-content" id="v-pills-tabContent1">
                                    <!-- Overview Tab -->
                                    <div class="tab-pane fade active show" id="v-pills-home-right" role="tabpanel"
                                        aria-labelledby="v-pills-home-tab">
                                        <p class="mb-2">Welcome to your dashboard. Get an at-a-glance view of your recent
                                            activity, top stats, and personalized suggestions to enhance productivity and
                                            stay on track.</p>
                                    ...
                                    <!-- Profile Tab -->
                                    <div class="tab-pane fade" id="v-pills-profile-right" role="tabpanel"
                                        aria-labelledby="v-pills-profile-tab">
                                        <p class="mb-2">Manage your personal details, change your profile photo, and
                                            update your contact information.</p>
                                        <ul>
                                    ...
                                    <!-- Settings Tab -->
                                    <div class="tab-pane fade" id="v-pills-settings-right" role="tabpanel"
                                        aria-labelledby="v-pills-settings-tab">
                                        <p class="mb-2">Customize your preferences, notification options, and privacy
                                            settings.</p>
                                        <ul>
                                    ...
                                    <!-- Projects Tab -->
                                    <div class="tab-pane fade" id="v-pills-projects-right" role="tabpanel"
                                        aria-labelledby="v-pills-projects-tab">
                                        <p class="mb-2">Track all your active, completed, and upcoming projects in one
                                            place.</p>
                                        <ul>
                                    ...
                                    <!-- Support Tab -->
                                    <div class="tab-pane fade" id="v-pills-support-right" role="tabpanel"
                                        aria-labelledby="v-pills-support-tab">
                                        <p class="mb-2">Need assistance? Access our help center or contact our support
                                            team directly.</p>
                                        <ul>
                            ...
                            <div class="col-sm-3 mt-2 mt-sm-0">
                                <div class="nav flex-column nav-pills nav-pills-secondary" id="v-pills-tab"
                                    role="tablist" aria-orientation="vertical">
                                    <a class="nav-link fw-semibold active show" id="v-pills-home-tab-right"
                                        data-bs-toggle="pill" href="#v-pills-home-right" role="tab"
                                        aria-controls="v-pills-home" aria-selected="true">
                                        Overview
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-profile-tab-right" data-bs-toggle="pill"
                                        href="#v-pills-profile-right" role="tab" aria-controls="v-pills-profile"
                                        aria-selected="false">
                                        Profile
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-settings-tab-right" data-bs-toggle="pill"
                                        href="#v-pills-settings-right" role="tab" aria-controls="v-pills-settings"
                                        aria-selected="false">
                                        Settings
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-projects-tab-right" data-bs-toggle="pill"
                                        href="#v-pills-projects-right" role="tab" aria-controls="v-pills-projects"
                                        aria-selected="false">
                                        Projects
                                    </a>
                                    <a class="nav-link fw-semibold" id="v-pills-support-tab-right" data-bs-toggle="pill"
                                        href="#v-pills-support-right" role="tab" aria-controls="v-pills-support"
                                        aria-selected="false">
                                        Support
                                    </a>
                                </div>
            ...
            <div class="col-xxl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="home-b1">
                                <p class="mb-0">Welcome to our online platform! Here, we strive to offer the best
                                    products and services tailored to your lifestyle. Whether you're redecorating your home
                                    or looking for expert advice on the latest trends, we've got you covered.</p>
                            </div>
                            <div class="tab-pane show active" id="profile-b1">
                                <p class="mb-0">Hi! I am an avid explorer, constantly seeking new adventures and
                                    insights. My passions include technology, literature, travel, fitness, and
                                    self-development. I enjoy learning new skills and sharing knowledge with others to
                                    foster personal growth.</p>
                            </div>
                            <div class="tab-pane" id="settings-b1">
                                <p class="mb-0">Nestled in the heart of the city, a charming cafe offers a peaceful
                                    retreat from the urban hustle. Its inviting ambiance, with its cozy decor and warm
                                    lighting, provides the perfect setting for relaxation or a productive meeting.</p>
                            </div>
                            <div class="tab-pane" id="about-b1">
            ...
            <div class="col-xxl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            You can add the <code>.nav-bordered-*</code> class to the <code>.nav</code> element to apply
                            colored border styles.
                        </p>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="home-b2">
                                <p class="mb-0">Welcome to our online platform! Our goal is to offer a wide variety of
                                    products and services that meet the needs of modern living. From cutting-edge technology
                                    to home decor solutions, we ensure that every product enhances your lifestyle and makes
                                    your life easier.</p>
                            </div>
                            <div class="tab-pane show active" id="profile-b2">
                                <p class="mb-0">Hi there! I'm an avid explorer with a passion for technology, fitness,
                                    and continuous learning. I enjoy meeting like-minded individuals and believe in
                                    expanding my knowledge on diverse subjects, from the latest gadgets to personal
                                    development.</p>
                            </div>
                            <div class="tab-pane" id="settings-b2">
                                <p class="mb-0">In the center of the city stands a quiet, charming bookstore that offers
                                    a peaceful retreat. Surrounded by vibrant streets, it provides a calm, inviting
                                    atmosphere for readers to lose themselves in books while enjoying a cup of coffee in the
                                    cozy corner.</p>
                            </div>
                            <div class="tab-pane" id="about-b2">
                                <p class="mb-0">We are a forward-thinking company focused on creating innovative
                                    solutions that empower our customers. Our team is driven by creativity and a passion for
                                    delivering exceptional experiences through high-quality products and services that cater
            ...
            <div class="col-xxl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="home-i1">
                                <p class="mb-0">Discover our platform designed to make your daily life easier. From
                                    modern interiors to smart home gadgets, our curated selection is tailored for comfort,
                            ...
                            <div class="tab-pane" id="settings-i1">
                                <p class="mb-0">A peaceful workspace can make all the difference. That’s why we offer
                                    customizable setups, soundproofing tips, and productivity tools to help you stay focused
                                    and inspired every day.</p>
                            </div>
                            <div class="tab-pane" id="about-i1">
                                <p class="mb-0">We’re a team of innovators passionate about creating seamless
                                    experiences. Our mission is to deliver solutions that merge design, functionality, and
                                    purpose in every project we undertake.</p>
                            </div>
                            <div class="tab-pane" id="projects-i1">
                                <p class="mb-0">Our recent projects range from mobile app development to full-scale
                                    branding initiatives. We believe in data-driven strategies paired with creative
                                    storytelling to drive results.</p>
                            </div>
                            <div class="tab-pane" id="contact-i1">
                                <p class="mb-0">Have questions or ideas? We'd love to hear from you! Reach out through
                                    our contact form, social media, or drop by our office for a chat over coffee.</p>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="home-ct">
                                <p class="mb-0">
                                    ...
                                    income, expenses, savings, and investments. Our tools are designed to help you make
                                    informed decisions and achieve your financial goals faster.
                                </p>
                            </div>
                            <div class="tab-pane show active" id="profile-ct">
                                <p class="mb-0">
                                    ...
                                    Link your financial institutions securely and keep track of balances, transactions, and
                                    payment schedules with ease.
                                </p>
                            </div>
                            <div class="tab-pane" id="settings-ct">
                                <p class="mb-0">
                                    Customize your preferences including budgeting alerts, currency format, report
                                    frequency, and security settings. Enable multi-factor authentication and choose how
                                    you'd like to receive account activity notifications.
                                </p>
                            </div>
                        </div>
                    </div> <!-- end card-body -->
