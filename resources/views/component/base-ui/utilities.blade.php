            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/utilities/background/"
                            target="_blank">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start flex-wrap gap-2">
                            ...
                            <img src="/images/users/user-2.jpg" class="avatar-lg rounded-start" alt="rounded-start">
                            <img src="/images/users/user-2.jpg" class="avatar-lg rounded-circle" alt="rounded-circle">
                            <img src="/images/stock/small-3.jpg" class="w-auto rounded-pill" alt="rounded-pill"
                                width="80">
                        </div>
                    </div> <!-- end card body-->
                </div> <!-- end card-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                            <div>
                                <img src="/images/stock/small-1.jpg" class="object-fit-contain border rounded avatar-xl"
                                    alt="...">
                                <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-contain</code></p>
                            </div>
                            <div>
                                <img src="/images/stock/small-1.jpg" class="object-fit-cover border rounded avatar-xl"
                                    alt="...">
                                <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-cover</code></p>
                            </div>
                            <div>
                                <img src="/images/stock/small-1.jpg" class="object-fit-fill border rounded avatar-xl"
                                    alt="...">
                                <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-fill</code></p>
                            </div>
                            <div>
                                <img src="/images/stock/small-1.jpg" class="object-fit-scale border rounded avatar-xl"
                                    alt="...">
                                <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-scale</code></p>
                            </div>
                            <div>
                                <img src="/images/stock/small-1.jpg" class="object-fit-none border rounded avatar-xl"
                                    alt="...">
                                <p class="mt-1 mb-0"><code class="user-select-all">.object-fit-none</code></p>
                            </div>
                        </div>
