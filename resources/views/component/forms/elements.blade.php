            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/forms/overview/"
                            target="_blank">
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        <div>
                                            ...
                                            <input type="email" class="form-control" id="labelInputInput1"
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">
                                                &lt;div&gt;
                                                &lt;label for=&quot;labelInputt1&quot; class=&quot;form-label&quot;&gt;Email
                                                address&lt;/label&gt;
                                                &lt;input type=&quot;email&quot; class=&quot;form-control&quot;
                                                id=&quot;labelInputt1&quot; placeholder=&quot;name@example.com&quot;&gt;
                                                &lt;/div&gt;
                                            </code>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">
                                                ...
                                                class=&quot;form-control-plaintext&quot; id=&quot;example-static&quot;
                                                value=&quot;email@example.com&quot;&gt;
                                            </code>
                                        </div>
                                    </div>
                        ...
                        <form>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">
                                            &lt;input type="color" id="example-color" class="form-control"
                                            value="#1ab394"&gt;
                                        </code>
                                    </div>
                                </div>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">
                                            &lt;input type="range" id="example-range" class="form-range"
                                            min="0" max="100"&gt;
                                        </code>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input form-check-input-light"
                                        id="checkLight">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value=""
                                        id="checkCheckedDisabled" checked disabled>
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                <div class="form-check mb-2">
                                    <input type="radio" class="form-check-input" name="gridRadio" id="radio1"
                                        checked>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="disabledRadioOptions"
                                        id="inlineRadio3" value="option3" checked disabled>
                                ...
                                <div class="d-flex flex-wrap gap-4">
                                    <div>
                                        ...
                                        <div class="form-check form-check-secondary mb-2">
                                            <input type="checkbox" class="form-check-input" id="checkSecondary"
                                                checked>
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                <div class="d-flex flex-wrap gap-4">
                                    <div>
                                        <div class="form-check form-check-primary mb-2">
                                            <input type="radio" class="form-check-input" name="radioPrimary"
                                                id="radioPrimary" checked>
                                            <label class="form-check-label" for="radioPrimary">Primary</label>
                                        </div>
                                        <div class="form-check form-check-secondary mb-2">
                                            <input type="radio" class="form-check-input" name="radioSecondary"
                                                id="radioSecondary" checked>
                                            <label class="form-check-label" for="radioSecondary">Secondary</label>
                                        </div>
                                        <div class="form-check form-check-success mb-2">
                                            <input type="radio" class="form-check-input" name="radioSuccess"
                                                id="radioSuccess" checked>
                                            <label class="form-check-label" for="radioSuccess">Success</label>
                                        </div>
                                        <div class="form-check form-check-info mb-2">
                                            <input type="radio" class="form-check-input" name="radioInfo"
                                                id="radioInfo" checked>
                                            <label class="form-check-label" for="radioInfo">Info</label>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="form-check form-check-warning mb-2">
                                            <input type="radio" class="form-check-input" name="radioWarning"
                                                id="radioWarning" checked>
                                            <label class="form-check-label" for="radioWarning">Warning</label>
                                        </div>
                                        <div class="form-check form-check-danger mb-2">
                                            <input type="radio" class="form-check-input" name="radioDanger"
                                                id="radioDanger" checked>
                                            <label class="form-check-label" for="radioDanger">Danger</label>
                                        </div>
                                        <div class="form-check form-check-purple mb-2">
                                            <input type="radio" class="form-check-input" name="radioPurple"
                                                id="radioPurple" checked>
                                            <label class="form-check-label" for="radioPurple">Purple</label>
                                        </div>
                                        <div class="form-check form-check-dark">
                                            <input type="radio" class="form-check-input" name="radioDark"
                                                id="radioDark" checked>
                                ...
                                <div class="d-flex flex-wrap gap-4">
                                    ...
                                    <div>
                                        <div class="form-check form-check-warning form-switch mb-2">
                                            <input type="checkbox" class="form-check-input" id="switchWarning"
                                                checked>
