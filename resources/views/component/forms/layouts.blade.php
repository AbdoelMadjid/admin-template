                    ...
                    <div class="card-body">
                        <div class="row g-4 align-items-center">
                                    ...
                                    <form>
                                        ...
                                        <div class="d-flex flex-wrap justify-content-between">
                                            <div class="form-check fs-sm">
                                                <input class="form-check-input form-check-input-light" type="checkbox"
                                                    id="rememberMe1">
                            ...
                            <div class="col-sm-6 text-center">
                                ...
                                <p class="text-muted mb-3">Join us today and unlock access to personalized features,
                                    updates, and more!</p>
                                <a href="{{ route('second', ['auth1', 'login']) }}"
                                    class="link-primary text-decoration-underline fw-semibold link-offset-3">Create Your
                                    Account</a>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end card-body-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <a data-bs-toggle="modal" class="btn btn-primary" href="#modal-form">Form in simple modal
                                box</a>
                        </div>
                                        ...
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm-6 border-end border-dashed">
                                                <div class="p-4">
                                                    ...
                                                    <form>
                                                        <div class="mb-3">
                                                            <label for="userEmail1" class="form-label">Email address <span
                                                                    class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="userPassword1" class="form-label">Password <span
                                                                    class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                                <input type="password" class="form-control"
                                                                    id="userPassword1" placeholder="••••••••" required>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="avatar avatar-xl mx-auto">
                                                    <span
                                                        ...
                                                        <i data-lucide="shield-user"
                                                            class="text-purple fs-28 fill-purple"></i>
                                                    </span>
                                                </div>
                                                <h4 class="mt-3">Don't Have an Account Yet?</h4>
