            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://robinherbots.github.io/Inputmask/"
                            target="_blank">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-link p-0 fw-semibold" href="https://twitter.github.io/typeahead.js/"
                            target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control bloodhound-typeahead" type="text" autocomplete="off"
                                    placeholder="Enter states from USA">
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control prefetch-typeahead" type="text" autocomplete="off"
                                    placeholder="Enter states from USA">
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control default-suggestions-typeahead" type="text"
                                    autocomplete="off" placeholder="Default Suggestions">
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control custom-template-typeahead" type="text" autocomplete="off"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control multi-datasets-typeahead" type="text" autocomplete="off"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group" data-touchspin>
                                    <button type="button" class="btn btn-light floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="1"
                                        max="800000">
                                    <button type="button" class="btn btn-light floating" data-plus><i
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group input-group-sm" data-touchspin>
                                    <button type="button" class="btn btn-light floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control border-0" value="0"
                                        max="800000">
                                    <button type="button" class="btn btn-light floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group" data-touchspin>
                                    <button type="button" class="btn btn-primary floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-primary floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-secondary floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-secondary floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-info floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-info floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-success floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-success floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-warning floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-warning floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-danger floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-danger floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-dark floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-dark floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-purple floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-purple floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <button type="button" class="btn btn-soft-primary floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-soft-primary floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group" data-touchspin>
                                    <button type="button" class="btn btn-light floating" data-minus disabled><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="1"
                                        max="800000" disabled>
                                    <button type="button" class="btn btn-light floating" data-plus disabled><i
                                            class="ti ti-plus"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group" data-touchspin>
                                    <button type="button" class="btn btn-primary rounded-circle floating" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control form-control-sm border-0" value="100"
                                        max="800000">
                                    <button type="button" class="btn btn-primary rounded-circle floating" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>
                                ...
                                <div class="input-group border-0 mt-2" data-touchspin>
                                    <button type="button" class="btn btn-outline-secondary" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control border-secondary" value="2"
                                        min="0" max="100">
                                    <button type="button" class="btn btn-outline-secondary" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>

                                <div class="input-group border-0 mt-2" data-touchspin>
                                    <button type="button" class="btn btn-soft-success" data-minus><i
                                            class="ti ti-minus"></i></button>
                                    <input type="number" class="form-control border-success-subtle" value="2"
                                        min="0" max="100">
                                    <button type="button" class="btn btn-soft-success" data-plus><i
                                            class="ti ti-plus"></i></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="input-group input-group-sm" data-touchspin>
                                    <div class="btn-group-vertical">
                                        <button type="button" class="btn btn-soft-success" data-plus><i
                                                class="ti ti-plus"></i></button>
                                        <button type="button" class="btn btn-soft-danger" data-minus><i
                                                class="ti ti-minus"></i></button>
                                    </div>
                                    <input type="number" class="form-control border-0" value="1" min="0"
                                        max="10">
                                </div>

                                <div class="input-group mt-2" data-touchspin>
                                    <div class="btn-group-vertical">
                                        <button type="button" class="btn btn-success" data-plus><i
                                                class="ti ti-plus"></i></button>
                                        <button type="button" class="btn btn-danger" data-minus><i
                                                class="ti ti-minus"></i></button>
                                    </div>
                                    <input type="number" class="form-control border-0" value="1" min="0"
                                        max="10">
                                ...
                                <div class="input-group input-group-lg mt-2" data-touchspin>
                                    <div class="btn-group-vertical">
                                        <button type="button" class="btn btn-dark" data-plus><i
                                                class="ti ti-plus"></i></button>
                                        <button type="button" class="btn btn-dark" data-minus><i
                                                class="ti ti-minus"></i></button>
                                    </div>
                                    <input type="number" class="form-control border-0" value="1" min="0"
                                        max="10">
