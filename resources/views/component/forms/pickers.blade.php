...
@section('css')
    @vite(['node_modules/daterangepicker/daterangepicker.css', 'node_modules/@simonwep/pickr/dist/themes/classic.min.css', 'node_modules/@simonwep/pickr/dist/themes/monolith.min.css', 'node_modules/@simonwep/pickr/dist/themes/nano.min.css', 'node_modules/flatpickr/dist/flatpickr.min.css'])
@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">
                            ...
                            Perfect for forms and dashboards, it supports calendar views, time pickers, and predefined
                            ranges.
                        </p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control date" id="daterangetime" data-toggle="date-picker"
                            ...
                            <div class="col-lg-6">
                                <div class="position-relative">
                                    <div id="reportrange" class="form-control" data-toggle="date-picker-range"
                                        ...
                                        <i
                                            class="ti ti-chevron-down position-absolute end-0 top-50 translate-middle me-1"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" data-provider="flatpickr"
                                    data-date-format="d M, Y" data-default-date="25 12,2021">
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <h5>Week Numbers</h5>
                                <p class="text-muted mb-0">Set <code>data-provider="flatpickr" data-week-number</code>.
                                </p>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" data-provider="flatpickr"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" data-provider="flatpickr"
                                    data-date-format="d M, Y" data-default-date="25 01,2021" data-inline-date="true">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" data-provider="timepickr"
                                    data-time-basic="true" id="timepicker-example" placeholder="Select Time">
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" data-provider="timepickr"
                                    data-time-hrs="true" id="timepicker-24hrs" placeholder="Select Time">
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" data-provider="timepickr"
                                    data-min-time="13:00" data-max-time="16:00" placeholder="Select Time">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-lg-6">
                                ...
                                <p class="text-muted mb-0">Use <code>nano-colorpicker</code> class to set nano colorpicker.
                                </p>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-lg-6">
                                ...
                                <p class="text-muted mb-0">Use <code>colorpicker-opacity-hue</code> class to set
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-lg-6">
                                ...
                                <p class="text-muted mb-0">Use <code>colorpicker-switch</code> class to set switch
                                    colorpicker.</p>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-lg-6">
                                ...
                                <p class="text-muted mb-0">Use <code>colorpicker-format</code> class to set colorpicker
