                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">
                            noUiSlider is a lightweight, ARIA-accessible JavaScript range slider with multi-touch and
                            keyboard support. It is fully GPU animated: no reflows, so it is fast; even on older devices. It
                            also fits wonderfully in responsive designs and has no dependencies
                        </p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div data-slider="default" data-slider-style="line" data-slider-size="sm" data-value="180"
                                    class="mt-3"></div>
                                <div data-slider="default" data-slider-style="line" data-slider-size="lg" data-value="90"
                                    class="mt-4"></div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-8">
                                <div data-slider="default" data-slider-color="primary" data-value="240" class="mb-4">
                                </div>
                                <div data-slider="default" data-slider-color="secondary" data-value="185" class="mb-4">
                                </div>
                                <div data-slider="default" data-slider-color="success" data-value="90" class="mb-4"></div>
                                <div data-slider="default" data-slider-color="info" data-slider-style="line"
                                    data-value="125" class="mb-4"></div>
                                <div data-slider="default" data-slider-color="warning" data-value="155" class="mb-4">
                                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                <button id="lockbutton" class="btn btn-sm btn-primary"><i class="ti ti-lock me-1"></i>
                                    Lock</button>
                            </div>
                        </div>
