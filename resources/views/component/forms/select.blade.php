            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <input id="basicTagify" class="form-control" name="basicTagify"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <input id="removeTagify" class="form-control mb-2" data-blacklist=".NET, PHP"
                                    name="input" placeholder="Type an English letter"
                                    value="HTML, UI Design, Figma, HTML">
                                <button class="tags--removeAllBtn btn btn-sm btn-soft-danger" type="button">Remove all
                                    these tags</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <input class="form-control" name="input-custom-dropdown"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="customLook form-control" placeholder="Enter email address"
                                value="some.name@website.com">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <input class="tagify--outside form-control" name="tags-outside"
                                    placeholder="write tags to add below" value="tag1, tag2, tag3">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <input class="form-control" name="readonly-mix" placeholder="Type something"
