                                ...
                                <a class="nav-link active" data-bs-toggle="tab" href="#stuInfo">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                            <span class="mb-0 lh-base d-block fw-semibold text-body fs-base">Student
                                                Info</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#addrInfo">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                            <span class="mb-0 lh-base d-block fw-semibold text-body fs-base">Address
                                                Info</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#courseInfo">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                            <span class="mb-0 lh-base d-block fw-semibold text-body fs-base">Course
                                                Info</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#parentInfo">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                            <span class="mb-0 lh-base d-block fw-semibold text-body fs-base">Parent
                                                Info</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#documents">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="flex-grow-1 ms-2 text-truncate">
                                            <span
                                                class="mb-0 lh-base d-block fw-semibold text-body fs-base">Documents</span>
                        ...
                        <div class="tab-content pt-3" data-wizard-content>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" data-provider="flatpickr" data-date-format="d M, Y"
                                                placeholder="Select you DOB" class="form-control" name="dob" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end mt-3">
                                    <button type="button" class="btn btn-primary" data-wizard-next>Next: Address Info
                                        →</button>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="addrInfo">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <button type="button" class="btn btn-secondary" data-wizard-prev>← Back: Student
                                        Info</button>
                                    <button type="button" class="btn btn-primary" data-wizard-next>Next: Course Info
                                        →</button>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="courseInfo">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <button type="button" class="btn btn-secondary" data-wizard-prev>← Back: Address
                                        Info</button>
                                    <button type="button" class="btn btn-primary" data-wizard-next>Next: Parent Info
                                        →</button>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="parentInfo">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <button type="button" class="btn btn-secondary" data-wizard-prev>← Back: Course
                                        Info</button>
                                    <button type="button" class="btn btn-primary" data-wizard-next>Next: Documents
                                        →</button>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="documents">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <button type="button" class="btn btn-secondary" data-wizard-prev>← Back: Parent
                                        Info</button>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3">
                                                <label class="form-label">Date of Birth</label>
                                                <input type="text" data-provider="flatpickr" data-date-format="d M, Y"
                                                    placeholder="Select your birth date" class="form-control"
                                                    name="dob" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade show active" id="progressStepStudent">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 mb-3">
                                            <label class="form-label">Date of Birth</label>
                                            <input type="text" data-provider="flatpickr" data-date-format="d M, Y"
                                                placeholder="Select your birth date" class="form-control" name="dob"
                                                required>
                                        </div>
                                    </div>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#verticalStepStudent">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            class="mb-0 lh-base d-block fw-semibold text-body fs-base">Student
                                                            Info</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#verticalStepAddress">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            class="mb-0 lh-base d-block fw-semibold text-body fs-base">Address
                                                            Info</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#verticalStepCourse">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            class="mb-0 lh-base d-block fw-semibold text-body fs-base">Course
                                                            Info</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#verticalStepParent">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            class="mb-0 lh-base d-block fw-semibold text-body fs-base">Parent
                                                            Info</span>
                                                        <span class="fs-xxs mb-0">Guardian details</span>
                                                    </span>
                                                </span>
                                        ...
                                        <div class="tab-pane fade show active" id="verticalStepStudent">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Date of Birth</label>
                                                        <input type="text" data-provider="flatpickr"
                                                            data-date-format="d M, Y" placeholder="Select birth date"
