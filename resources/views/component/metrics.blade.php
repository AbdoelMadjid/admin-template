            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="p-3">
                                <h3 class="mb-3 fw-bold"><span data-target="421">0</span><span
                ...
                <div class="col-xl-4">
                    <div class="card text-bg-secondary border-0">
                        <div class="card-body p-0">
                            <div class="p-3 mb-3">
                                <h3 class="mb-3 fw-bold"><span data-target="185">0</span><span
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="mb-3 fw-bold">$<span data-target="12.5">0</span>k<span
