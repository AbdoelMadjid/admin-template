            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="row row-cols-xxl-2 row-cols-md-2 row-cols-1 g-1 p-1">
                        ...
                        <div class="col">
                            <div
                                class="card bg-primary border-primary shadow-none bg-opacity-10 rounded-0 border border-dashed mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="progress bg-primary bg-opacity-25 progress-sm mb-0">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: 18.45%"
                                            aria-valuenow="18.45" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                            ...
                            <div class="card rounded-0 border shadow-none border-dashed mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="progress progress-sm mb-0">
                                        <div class="progress-bar bg-secondary" role="progressbar" style="width: 10.35%"
                                            aria-valuenow="10.35" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col">
                            <div class="card rounded-0 border shadow-none border-dashed mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="progress progress-sm mb-0">
                                        <div class="progress-bar bg-secondary" role="progressbar" style="width: 5.92%"
                                            aria-valuenow="5.92" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col">
                            <div
                                class="card bg-secondary shadow-none border-secondary bg-opacity-10 rounded-0 border border-dashed mb-0">
                                <div class="card-body">
                                    <div class="mb-3 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="progress bg-secondary bg-opacity-25 progress-sm mb-0">
                                        <div class="progress-bar bg-secondary" role="progressbar" style="width: 22.61%"
                                            aria-valuenow="22.61" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col">
                            <div
                                class="card bg-warning bg-opacity-10 shadow-none rounded-0 border border-warning border-dashed mb-0">
                                <div class="card-body">
                                    <div class="mb-3 d-flex justify-content-between align-items-center">
                                        <h5 class="fs-xl mb-0">$24,500</h5>
                                        <span>18.45% <i class="ti ti-arrow-up text-success"></i></span>
                                    ...
                                    <div class="progress bg-warning bg-opacity-25 progress-sm mb-0">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 18.45%"
                                            aria-valuenow="18.45" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-xl-4">
            <div class="card border-top-0">
                <div class="position-relative card-side-img overflow-hidden rounded-top"
                    style="height: 180px; background-image: url(/images/profile-bg.jpg);">
                    <div
                    ...
                    <div class="d-flex justify-content-start gap-3">
                        <div class="avatar avatar-xxl" style="margin-top: -60px;">
                            <a href="{{ route('second', ['pages', 'profile']) }}">
                                <img src="/images/users/user-2.jpg" alt="User Profile"
                        ...
                        <div>
                            <h4 class="text-nowrap fw-bold mb-1">
                                <a href="{{ route('second', ['pages', 'profile']) }}"
                                    class="text-reset text-decoration-none">Damian D.</a>
                            </h4>
                            <p class="text-muted mb-0">Member since Jan 2021</p>
                        </div>
                        <button class="btn btn-icon btn-primary rounded-circle ms-auto" data-bs-toggle="dropdown"
                ...
                <div class="card-body">
                    <div class="d-flex border border-dashed rounded p-3">
                        ...
                        <div class="flex-grow-1 ms-2">
                            ...
                            <p class="mb-2">Loving the new dashboard update! The UI feels much smoother and more
                                intuitive now. Great job!</p>

                            <div class="d-flex justify-content-between mt-2 text-muted">
                                <div class="d-flex gap-3">
                                    <span class="d-inline-flex align-items-center gap-1"><i class="ti ti-eye"></i>
                                        1.2K</span>
                                    <span class="d-inline-flex align-items-center gap-1"><i class="ti ti-heart"></i>
                                        320</span>
                                    <span class="d-inline-flex align-items-center gap-1"><i
                                            class="ti ti-message-circle-2"></i> 14</span>
                                </div>
                            ...
                            <div class="d-flex mt-4">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h5 class="mb-1">Nina Bryant <small class="text-muted">15 Apr 2025 · 10:00AM</small>
                                    </h5>
                                    ...
                                    <div class="d-flex justify-content-between text-muted">
                                        <div class="d-flex gap-3">
                                            <span class="d-inline-flex align-items-center gap-1"><i class="ti ti-eye"></i>
                                                860</span>
                                            <span class="d-inline-flex align-items-center gap-1"><i
                                                    class="ti ti-heart"></i> 150</span>
                                            <span class="d-inline-flex align-items-center gap-1"><i
                                                    class="ti ti-message-circle-2"></i> 6</span>
                                        </div>
                                        <a href="javascript:void(0);"
                                            class="link-primary fw-semibold d-inline-flex align-items-center gap-1">
                                            <i class="ti ti-arrow-back-up"></i> Reply
                            ...
                            <div class="d-flex mt-4">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h5 class="mb-1">Sophie Allen <small class="text-muted">15 Apr 2025 ·
                                            12:10PM</small></h5>
                                    ...
                                    <div class="d-flex justify-content-between text-muted">
                                        <div class="d-flex gap-3">
                                            <span class="d-inline-flex align-items-center gap-1"><i class="ti ti-eye"></i>
                                                580</span>
                                            <span class="d-inline-flex align-items-center gap-1"><i
                                                    class="ti ti-heart"></i> 90</span>
                                            <span class="d-inline-flex align-items-center gap-1"><i
                                                    class="ti ti-message-circle-2"></i> 3</span>
                                        </div>
                                        <a href="javascript:void(0);"
                                            class="link-primary fw-semibold d-inline-flex align-items-center gap-1">
                                            <i class="ti ti-arrow-back-up"></i> Reply
        ...
        <div class="col-xl-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-2">
                        ...
                        <div class="avatar-group avatar-group-xs">
                            <div class="avatar"><img src="/images/users/user-4.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-7.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-1.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-2.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                        </div>
                        <div>
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-2">
                        ...
                        <div class="avatar-group avatar-group-xs">
                            <div class="avatar"><img src="/images/users/user-8.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-2.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-6.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-9.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-10.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                        </div>
                        <div>
                            <a href="#" class="btn btn-sm btn-icon btn-default" title="Download"><i
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-2">
                        <div class="d-flex align-items-center py-1 gap-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-base"><a href="#!" class="link-reset">Marketing-Plan.pptx</a>
                                </h5>
                        ...
                        <div class="avatar-group avatar-group-xs">
                            ...
                            <div class="avatar"><img src="/images/users/user-1.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-3.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                            <div class="avatar"><img src="/images/users/user-6.jpg" class="rounded-circle avatar-xs"
                                    alt=""></div>
                        </div>
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="javascript: void(0);" class="link-primary fw-semibold"><i
                            class="ti ti-calendar me-1"></i><span>Invite</span></a>
                </div> <!-- end card-header-->
                ...
                <div class="card-body">
                    <div class="pb-2 border-bottom border-light border-dashed">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="avatar-group avatar-group-xs">
                                <div class="avatar">
                                    <img src="/images/users/user-5.jpg" alt="Liam Carter"
                    ...
                    <div class="py-2 border-bottom border-light border-dashed">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="avatar-group avatar-group-xs">
                                ...
                                <div class="avatar">
                                    <img src="/images/users/user-8.jpg" alt="Ethan King"
                                        class="avatar-xs rounded-circle">
                                </div>
                                <div class="avatar">
                                    <img src="/images/users/user-9.jpg" alt="Lucas White"
                                        class="avatar-xs rounded-circle">
                                </div>
                            </div>
                            <button type="button" class="btn btn-sm btn-soft-secondary rounded-circle btn-icon">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress bg-success progress-md bg-opacity-25">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 72.5%"
                            aria-valuenow="72.5" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="progress bg-success progress-md bg-opacity-25">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 99.9%"
                            aria-valuenow="99.9" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (container && container.SimpleBar) {
                container.SimpleBar.getScrollElement().scrollTop = container.SimpleBar.getScrollElement()
                    .scrollHeight;
            } else {
