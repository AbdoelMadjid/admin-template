...
@section('content')
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1"><span data-target="14.59">0</span>M <span
                                                        class="text-success fs-base">+5.2% <i
                                                            class="ti ti-trending-up"></i></span></h3>
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1"><span data-target="815.58">0</span>k <span
                                                        class="text-success fs-base">+3.9% <i
                                                            class="ti ti-activity"></i></span></h3>
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1"><span data-target="41.3">0</span>% <span
                                                        class="text-danger fs-base">-1.1% <i
                                                            class="ti ti-arrow-down-left"></i></span></h3>
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1"><span data-target="56.39">0</span>k <span
                                                        class="text-success fs-base">+2.3% <i
    ...
    <div class="asidebar-button d-xl-none d-flex">
        <button class="btn btn-danger btn-icon rounded-end-0" data-bs-toggle="offcanvas"
            data-bs-target="#asidebar-offcanvas">
