...
<div class="offcanvas offcanvas-end overflow-hidden" tabindex="-1" id="theme-settings-offcanvas">
    <div class="d-flex justify-content-between text-bg-primary gap-2 p-3" style="background-image: url(/images/user-bg-pattern.png);">
        <div>
            ...
            <p class="text-white text-opacity-75 fst-italic fw-medium mb-0" data-lang="customizer-description">Easily configure layout, styles, and preferences for your admin interface.</p>
        </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-classic">
                            ...
                            <i class="ti ti-rosette-discount-check card-radio-check"></i>
                        </label>
                    </div>
                    <h5 class="text-center text-muted mt-2 mb-0" data-lang="customizer-theme-classic">Classic</h5>
                </div>
        ...
        <div class="p-3 border-bottom border-dashed">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <h5 class="text-center text-muted mt-2 mb-0" data-lang="customizer-color-dark">Dark</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="text-center text-muted mt-2 mb-0" data-lang="customizer-color-system">System</h5>
                </div>
            </div>
        </div>
        ...
        <div class="p-3 border-bottom border-dashed">
            ...
            <div class="row g-3">
                <div class="col-4">
                    ...
                    <h5 class="mb-0 text-center text-muted mt-2" data-lang="customizer-sidebar-size-default">Default</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="mb-0 text-center text-muted mt-2" data-lang="customizer-sidebar-size-compact">Compact</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="mb-0 text-center text-muted mt-2" data-lang="customizer-sidebar-size-condensed">Condensed</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="mb-0 text-center text-muted mt-2" data-lang="customizer-sidebar-size-on-hover">On Hover</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="mb-0 fs-base text-center text-muted mt-2" data-lang="customizer-sidebar-size-on-hover-show">On Hover - Show</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="mb-0 text-center text-muted mt-2" data-lang="customizer-sidebar-size-offcanvas">Offcanvas</h5>
                </div>
            </div>
        </div>
        ...
        <div class="p-3 border-bottom border-dashed">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group radio" role="group">
                    ...
                    <label class="btn btn-sm btn-soft-warning w-sm" for="layout-position-fixed" data-lang="customizer-layout-fixed">Fixed</label>

                    <input type="radio" class="btn-check" name="data-layout-position" id="layout-position-scrollable" value="scrollable">
                    <label class="btn btn-sm btn-soft-warning w-sm ms-0" for="layout-position-scrollable" data-lang="customizer-layout-scrollable">Scrollable</label>
                </div>
            </div>
        </div>
        ...
        <div class="p-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><label class="fw-bold m-0" for="sidebaruser-check" data-lang="customizer-sidebar-user-info">Sidebar User Info</label></h5>
    ...
    <div class="offcanvas-footer border-top p-3 text-center">
        <div class="row">
            <div class="col-6">
                <button type="button" class="btn btn-light fw-semibold py-2 w-100" id="reset-layout" data-lang="customizer-reset">Reset</button>
            </div>
            <div class="col-6">
                <a href="https://wrapbootstrap.com/theme/inspinia-multipurpose-admin-dashboard-template-WB0R5L90S?ref=inspinia" target="_blank" class="btn btn-danger bg-gradient py-2 fw-semibold w-100" data-lang="customizer-buy-now">Buy Now</a>
            </div>
        </div>
    </div>
</div>
