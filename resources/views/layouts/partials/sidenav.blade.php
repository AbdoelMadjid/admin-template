        ...
        <ul class="side-nav">
            <li class="side-nav-item">
                <a href="{{ route('dashboard') }}" class="side-nav-link">
                    ...
                    <span class="menu-text" data-lang="dashboard-main">Dashboard</span>
                </a>
            </li>
            ...
            @include('layouts.partials.sidenav.apps')

            <li class="side-nav-title mt-2" data-lang="pages-title">Pages</li>

            @include('layouts.partials.sidenav.pages')

            <li class="side-nav-title mt-2" data-lang="layouts-title">Layouts</li>

            @include('layouts.partials.sidenav.style')

            <li class="side-nav-title mt-2" data-lang="components-title">Components</li>

            @include('layouts.partials.sidenav.component')

            <li class="side-nav-title mt-2" data-lang="documentation">Documentation</li>

            @include('layouts.partials.sidenav.documentation')

            <li class="side-nav-title mt-2" data-lang="items-title">Menu Items</li>

            @include('layouts.partials.sidenav.menu-item')
