                ...
                <div class="col-lg-5 col-md-8">
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-1">
                            ...
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">Apps</a>
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">Developers</a>
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">Repair</a>
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">Billing</a>
                        </div>
                    </div>
                </div><!-- end col -->
            </div><!-- end row -->
                            ...
                            <div class="accordion accordion-bordered" id="BorderedaccordionExample">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="BorderedheadingOne">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#BorderedcollapseOne"
                                            aria-expanded="true" aria-controls="BorderedcollapseOne">
                                            What is included in your template purchase?
                                        </button>
                                    </h2>
                                    <div id="BorderedcollapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="BorderedheadingTwo">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#BorderedcollapseTwo"
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="BorderedheadingThree">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#BorderedcollapseThree"
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="BorderedheadingFour">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#BorderedcollapseFour"
                                            aria-expanded="false" aria-controls="BorderedcollapseFour">
                                            Are the templates compatible with the latest frameworks?
                                        </button>
                                    </h2>
                                    <div id="BorderedcollapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="BorderedheadingFour" data-bs-parent="#BorderedaccordionExample">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="BorderedheadingFive">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#BorderedcollapseFive"
                                            aria-expanded="false" aria-controls="BorderedcollapseFive">
                                            Do you provide Figma or design files?
                                        </button>
                                    </h2>
                                    <div id="BorderedcollapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="BorderedheadingFive" data-bs-parent="#BorderedaccordionExample">
                                        <div class="accordion-body">
                            ...
                            <div class="accordion accordion-bordered" id="BorderedaccordionPayment">
                                ...
                                <div class="accordion-item border-0">
                                    ...
                                    <div id="paymentCollapseOne" class="accordion-collapse collapse"
                                        aria-labelledby="paymentHeadingOne" data-bs-parent="#BorderedaccordionPayment">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    ...
                                    <div id="paymentCollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="paymentHeadingTwo" data-bs-parent="#BorderedaccordionPayment">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    ...
                                    <div id="paymentCollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="paymentHeadingThree" data-bs-parent="#BorderedaccordionPayment">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="paymentHeadingFour">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#paymentCollapseFour" aria-expanded="false"
                                            aria-controls="paymentCollapseFour">
                                            Can I upgrade my license later?
                                        </button>
                                    </h2>
                                    <div id="paymentCollapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="paymentHeadingFour" data-bs-parent="#BorderedaccordionPayment">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="paymentHeadingFive">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#paymentCollapseFive" aria-expanded="false"
                                            aria-controls="paymentCollapseFive">
                                            Why was my payment declined?
                                        </button>
                                    </h2>
                                    <div id="paymentCollapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="paymentHeadingFive" data-bs-parent="#BorderedaccordionPayment">
                                        <div class="accordion-body">
                            ...
                            <div class="accordion accordion-bordered" id="BorderedaccordionRefund">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="refundHeadingOne">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#refundCollapseOne"
                                            aria-expanded="true" aria-controls="refundCollapseOne">
                                            What is your refund policy?
                                        </button>
                                    </h2>
                                    <div id="refundCollapseOne" class="accordion-collapse collapse"
                                        aria-labelledby="refundHeadingOne" data-bs-parent="#BorderedaccordionRefund">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="refundHeadingTwo">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#refundCollapseTwo"
                                            aria-expanded="false" aria-controls="refundCollapseTwo">
                                            How do I request a refund?
                                        </button>
                                    </h2>
                                    <div id="refundCollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="refundHeadingTwo" data-bs-parent="#BorderedaccordionRefund">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="refundHeadingThree">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#refundCollapseThree" aria-expanded="false"
                                            aria-controls="refundCollapseThree">
                                            Are there any non-refundable purchases?
                                        </button>
                                    </h2>
                                    <div id="refundCollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="refundHeadingThree" data-bs-parent="#BorderedaccordionRefund">
                                        <div class="accordion-body">
                            ...
                            <div class="accordion accordion-bordered" id="BorderedaccordionCustom">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="customHeadingOne">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#customCollapseOne"
                                            aria-expanded="true" aria-controls="customCollapseOne">
                                            Do you offer customization services?
                                        </button>
                                    </h2>
                                    <div id="customCollapseOne" class="accordion-collapse collapse"
                                        aria-labelledby="customHeadingOne" data-bs-parent="#BorderedaccordionCustom">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="customHeadingTwo">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#customCollapseTwo"
                                    ...
                                    <div id="customCollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="customHeadingTwo" data-bs-parent="#BorderedaccordionCustom">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item border-0">
                                    <h2 class="accordion-header" id="customHeadingThree">
                                        <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed"
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#customCollapseThree" aria-expanded="false"
                                    ...
                                    <div id="customCollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="customHeadingThree" data-bs-parent="#BorderedaccordionCustom">
                                        <div class="accordion-body">
