                ...
                <div class="card-header d-block">
                    <div class="text-center w-md-75 w-xl-50 mx-auto py-3">
                        <div class="app-search app-search-pill input-group mb-3 rounded-pill">
                            <input type="text" class="form-control bg-light-subtle border-light py-2 fw-semibold"
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-1">
                            ...
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">Analytics</a>
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">SaaS</a>
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">Ecommerce</a>
                            <a href="#!"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">CRM</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header border-light justify-content-between">
                    <h4 class="fst-italic text-muted mb-0">
                        Found <span class="fw-bold badge badge-soft-danger">89</span> results for <span
                            class="text-dark">"React Dashboard"</span>
                    </h4>
                ...
                <div class="card-body p-0">
                    <div class="border-bottom border-dashed px-4 py-3">
                        ...
                        <p class="text-muted mb-2">
                            INSPINIA is a premium admin dashboard template built with <span
                                class="fw-semibold">Bootstrap</span>. It offers a wide range of UI components, layouts, and
                            features for building modern web apps like CRMs, SaaS dashboards, and admin panels.
                        </p>
                        <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                            ...
                            <span><i class="ti ti-message-circle"></i> <a href="#!" class="link-reset">Comments:
                                    54</a></span>
                    ...
                    <div class="border-bottom border-dashed px-4 py-3">
                        <h4 class="fs-md mb-1">
                            <a href="https://wrapbootstrap.com/theme/homer-responsive-admin-template-WB055J451?ref=inspinia"
                                target="_blank" class="text-reset">
                        ...
                        <p class="text-muted mb-2">
                            Homer is a clean and fully responsive admin dashboard built with <span
                                class="fw-semibold">Bootstrap</span>. It features a modern design, modular structure, and
                            reusable UI components, making it ideal for analytics dashboards, CRM systems, and custom
                            backend solutions.
                        </p>
                        <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                            <span class="d-flex align-items-center gap-1">
                    ...
                    <div class="border-bottom border-dashed px-4 py-3">
                        <h4 class="fs-md mb-1">
                            <a href="https://wrapbootstrap.com/theme/luna-responsive-admin-dashboard-template-WB0J69TPB?ref=inspinia"
                                target="_blank" class="text-reset">
                        ...
                        <p class="text-muted mb-2">
                            LUNA is a stylish and responsive admin theme built with <span
                                class="fw-semibold">Bootstrap</span>. It includes clean layouts, powerful UI elements, and a
                            lightweight structure—perfect for backend systems, SaaS products, and admin panels.
                        </p>
                        <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                            <span class="d-flex align-items-center gap-1">
                    ...
                    <div class="border-bottom border-dashed px-4 py-3">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <div class="px-3 py-2 bg-light bg-opacity-50 rounded">
                                <a href="#!" class="text-reset fs-md fw-semibold">Minimal Admin Templates <i
                                        class="ti ti-search ms-2"></i></a>
                            </div>
                            <div class="px-3 py-2 bg-light bg-opacity-50 rounded">
                                <a href="#!" class="text-reset fs-md fw-semibold">Bootstrap 5 Admin Panels <i
                                        class="ti ti-search ms-2"></i></a>
                            </div>
                            <div class="px-3 py-2 bg-light bg-opacity-50 rounded">
                                <a href="#!" class="text-reset fs-md fw-semibold">SaaS Dashboard UI Kits <i
                                        class="ti ti-search ms-2"></i></a>
                            </div>
                            <div class="px-3 py-2 bg-light bg-opacity-50 rounded">
                                <a href="#!" class="text-reset fs-md fw-semibold">Dark Mode Admin Themes <i
                                        class="ti ti-search ms-2"></i></a>
                            </div>
                        </div>
                    </div>
