            ...
            <div class="card position-relative">
                <div class="position-absolute top-0 end-0">
                    <svg style="opacity: 0.05;" width="600" height="560" viewBox="0 0 600 560" fill="none"
                        ...
                        <!-- Wavy Path -->
                        <path d="M460 120 C470 90, 500 90, 510 120 S550 150, 560 120" stroke="#1c84c6" stroke-width="2"
                            fill="none" />
                        ...
                        <!-- Spiral -->
                        <path d="M290 100 C300 90, 310 110, 300 120 C290 130, 270 130, 260 120 C250 110, 250 90, 260 80"
