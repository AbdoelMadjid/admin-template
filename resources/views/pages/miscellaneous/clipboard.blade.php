                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p class="text-muted mb-0">Use <code>data-clipboard-target</code> to copy text from a
                                            specific element.</p>
                                    </td>
                                    <td>
                                        <p class="text-primary font-bold" id="copytext">Click the button to copy this
                                            promotional text.</p>
                                        <button class="btn btn-sm btn-primary" data-clipboard-target="#copytext"><i
                                                class="ti ti-copy me-1"></i> Copy Text</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p class="text-muted mb-0">Use <code>data-clipboard-action</code> with
                                            <code>cut</code> to remove and copy content.</p>
                                    </td>
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-primary mt-3" data-clipboard-action="cut"
                                            data-clipboard-target="#cuttext"><i class="ti ti-cut me-1"></i> Cut
                                            Content</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="cutInput" class="form-control"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text" id="discountCode" class="form-control" value="SAVE20NOW"
                                                readonly>
                                            <button class="btn btn-icon btn-warning" type="button"
                                                data-clipboard-target="#discountCode">
                                                <i class="ti ti-copy fs-lg"></i>
                                            </button>
                                        </div>
                                    </td>
