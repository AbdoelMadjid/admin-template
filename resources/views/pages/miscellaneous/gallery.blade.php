    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Grid -->
                    <div class="row row-cols-xxl-5 row-cols-lg-4 row-cols-md-3 g-2 row-cols-1 position-relative"
                        id="grid">
                        <div class="col position-absolute" data-category="beautiful">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">
                                    beautiful</div>
                        ...
                        <div class="col position-absolute" data-category="nature">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-danger badge-label position-absolute top-0 start-0 m-3 z-1">Health
                                </div>
                        ...
                        <div class="col position-absolute" data-category="beautiful">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-primary badge-label position-absolute top-0 start-0 m-3 z-1">
                                    Travel</div>
                        ...
                        <div class="col position-absolute" data-category="nature">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-warning badge-label position-absolute top-0 start-0 m-3 z-1">
                                    Sports</div>
                        ...
                        <div class="col position-absolute" data-category="nature">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-info badge-label position-absolute top-0 start-0 m-3 z-1">Business
                                </div>
                        ...
                        <div class="col position-absolute" data-category="travel">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-success badge-label position-absolute top-0 start-0 m-3 z-1">
                                    Education</div>
                        ...
                        <div class="col position-absolute" data-category="city">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-secondary badge-label position-absolute top-0 start-0 m-3 z-1">
                                    Fashion</div>
                        ...
                        <div class="col position-absolute" data-category="travel">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-success badge-label position-absolute top-0 start-0 m-3 z-1">Food
                                </div>
                        ...
                        <div class="col position-absolute" data-category="beautiful">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-danger badge-label position-absolute top-0 start-0 m-3 z-1">
                                    Entertainment</div>
                        ...
                        <div class="col position-absolute" data-category="city">
                            <div class="card border-0 mb-0">
                                <div class="badge text-bg-light badge-label position-absolute top-0 start-0 m-3 z-1">
                                    Lifestyle</div>
