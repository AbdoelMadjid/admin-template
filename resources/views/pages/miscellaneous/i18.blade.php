    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('lang.switch', 'en') }}" class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="en">
                ...
                <a href="{{ route('lang.switch', 'id') }}" class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="id">
                    <img src="/images/flags/id.svg" alt="Indonesian" class="me-1 rounded" height="18"
                        data-translator-image> <span class="align-middle">Bahasa Indonesia</span>
                </a>

                <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="en">
                    <img src="/images/flags/us.svg" alt="English Demo" class="me-1 rounded" height="18"
                        data-translator-image> <span class="align-middle">English (Demo)</span>
                </button>

                <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="id">
                    <img src="/images/flags/id.svg" alt="Indonesian Demo" class="me-1 rounded" height="18"
                        data-translator-image> <span class="align-middle">Indonesia (Demo)</span>
                </button>
            </div>
