        ...
        <div class="col-xxl-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        The Idle Timer plugin allows you to monitor user activity on the page. Idle is defined as a lack of
                        mouse movement, scrolling, or keyboard input.
                    </p>
                    ...
                    <p class="mb-0">
                        You can instantiate the timer either statically or on a specific element. Element-bound timers will
                        only track activity within that element, whereas global timers will monitor activity on the entire
                        page. To set up page-level activity, you can initialize the timer on <code>document</code>,
                        <code>document.documentElement</code>, or <code>document.body</code>.
                        The initialization returns a jQuery object, allowing for method chaining.
                    </p>

                    <div class="toast-container position-fixed top-0 end-0 p-3">
                        <!-- Success Toast -->
                        <div id="backToast" class="toast shadow-lg text-bg-success border-success" role="alert"
                        ...
                        <!-- Toast container -->
                        <div id="liveToast" class="toast shadow-lg text-bg-warning border-warning" role="alert"
                            aria-live="assertive" aria-atomic="true">
