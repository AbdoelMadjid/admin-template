    ...
    fallback: true
                ...
                <div class="card-body">
                    ...
                    <p>
                        ...
                        You can show badge counts, change icon colors, and provide visual alerts when the user’s attention
                        is needed.
                    </p>

                    <p>
                        For browsers that don’t support canvas or dynamic favicons, Tinycon automatically falls back to
                        updating the document title with a count.
                    </p>
