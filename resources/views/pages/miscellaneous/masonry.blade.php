            ...
            <article class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">Mastering Figma: 7
                            Pro Tips for Better UI Design</a>
                    </h6>
                    <p class="mb-3 text-muted">
                        Unlock advanced techniques in Figma that can speed up your workflow and help you create
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between">
                    ...
                    <a class="link-primary fw-semibold" href="{{ route('third', ['apps', 'others', 'article']) }}">Read more
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card bg-danger bg-gradient">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="text-white">AI Breakthroughs to
                            Watch in 2025</a>
                    </h6>
                    <p class="mb-3 text-white-50">
                        Explore the game-changing AI innovations set to redefine industries and everyday life in the coming
                        year.
                    </p>
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between border-light border-opacity-25">
                    ...
                    <a class="text-white fw-semibold" href="{{ route('third', ['apps', 'others', 'article']) }}">Read more
                        <i class="ti ti-arrow-right"></i></a>
                </div>
            </article>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">SEO Strategies for
                            2025: How to Rank Higher</a>
                    </h6>
                    <p class="mb-3 text-muted">
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between">
                    ...
                    <a class="link-primary fw-semibold" href="{{ route('third', ['apps', 'others', 'article']) }}">Read
                        more <i class="ti ti-arrow-right"></i></a>
                </div>
            </article>
        </div> <!-- end col-->
        <div class="col-xl-3 col-md-6">
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">5 Key Tips for
                            New Entrepreneurs</a>
                    </h6>
                    <p class="mb-3 text-muted">
                        Start your entrepreneurial journey with these 5 essential tips that will guide you through the first
                        year of business.
                    </p>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">The Future of
                            Artificial Intelligence</a>
                    </h6>
                    <p class="mb-3 text-muted">
                        Discover how AI is transforming industries and what the future holds for this cutting-edge
                        technology.
                    </p>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card bg-secondary bg-gradient">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="text-white">Cyber Threats to
                            Watch Out for in 2025</a>
                    </h6>
                    <p class="mb-3 text-white-50">
                        Stay protected by understanding the most pressing cybersecurity threats and how to safeguard your
                        digital world.
                    </p>
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between border-light border-opacity-25">
                    ...
                    <a class="text-white fw-semibold" href="{{ route('third', ['apps', 'others', 'article']) }}">Read
                        more <i class="ti ti-arrow-right"></i></a>
                </div>
            </article>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">Top Data Science
                            Trends in 2025</a>
                    </h6>
                    <p class="mb-3 text-muted">
                        Get ahead in the data science field with the latest trends, technologies, and tools that are
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="link-reset">Web Design
                            Trends to Watch in 2025</a>
                    </h6>
                    <p class="mb-3 text-muted">
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card bg-success bg-gradient">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ route('third', ['apps', 'others', 'article']) }}" class="text-white">Sustainable
                            Technologies Shaping the Future</a>
                    </h6>
                    <p class="mb-3 text-white-50">
                        Discover how clean energy, eco-innovation, and green infrastructure are driving the global
...
@section('scripts')
    @vite(['resources/js/pages/masonry.js'])
@endsection
