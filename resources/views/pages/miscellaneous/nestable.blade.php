                ...
                <div class="card-body">
                    ...
                    <div class="list-group fw-medium nested-sortable-handle">
                        <div class="list-group-item nested-1"><i
                                class="ti ti-grip-horizontal align-middle sort-handle"></i>Project Alpha
                            <div class="list-group nested-sortable-handle">
                                <div class="list-group-item nested-2"><i
                                        class="ti ti-grip-horizontal align-middle sort-handle"></i>Design Phase</div>
                                <div class="list-group-item nested-2"><i
                                        class="ti ti-grip-horizontal align-middle sort-handle"></i>Development Phase
                                    <div class="list-group nested-sortable-handle">
                                        <div class="list-group-item nested-3"><i
                                                class="ti ti-grip-horizontal align-middle sort-handle"></i>Frontend Module
                                        </div>
                                        <div class="list-group-item nested-3"><i
                                                class="ti ti-grip-horizontal align-middle sort-handle"></i>Backend Module
                                        </div>
                                        <div class="list-group-item nested-3"><i
                                                class="ti ti-grip-horizontal align-middle sort-handle"></i>API Integration
                                        </div>
                                        <div class="list-group-item nested-3"><i
                                                class="ti ti-grip-horizontal align-middle sort-handle"></i>Unit Testing
                                        </div>
                                    </div>
                                </div>
                                <div class="list-group-item nested-2"><i
                                        class="ti ti-grip-horizontal align-middle sort-handle"></i>QA Review</div>
                                <div class="list-group-item nested-2"><i
                                        class="ti ti-grip-horizontal align-middle sort-handle"></i>Deployment</div>
                            </div>
                        </div>
                    </div>
                </div><!-- end card-body -->
                    ...
                    <div class="list-group border-dashed">
                        <div class="list-group-item">
                            ...
                            <div class="list-group nested-sortable border-0">
                                ...
                                <div class="list-group-item"><i class="ti ti-progress fs-sm me-2 text-muted"></i>In Progress
                                </div>
                                <div class="list-group-item"><i class="ti ti-checklist fs-sm me-2 text-muted"></i>Completed
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group nested-sortable border-0">
                                <div class="list-group-item"><i class="ti ti-flag fs-sm me-2 text-muted"></i>Project Kickoff
                                </div>
                                <div class="list-group-item"><i class="ti ti-flag fs-sm me-2 text-muted"></i>Phase 1
                                    Completion</div>
                                <div class="list-group-item"><i class="ti ti-flag fs-sm me-2 text-muted"></i>Final Delivery
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group nested-sortable border-0">
                                <div class="list-group-item"><i class="ti ti-user fs-sm me-2 text-muted"></i>Development
                                    Team</div>
                                <div class="list-group-item"><i class="ti ti-user fs-sm me-2 text-muted"></i>Design Team
                                </div>
