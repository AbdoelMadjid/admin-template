                        ...
                        <table class="table mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary" id="sweetalert-basic">Click
                                            me</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary" id="sweetalert-title">Click
                                            Me</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary" id="custom-html-alert">Toggle
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2">
                                            <button type="button" id="sweetalert-info" class="btn btn-sm btn-info">Toggle
                                                Info</button>
                                            <button type="button" id="sweetalert-warning"
                                                class="btn btn-sm btn-warning">Toggle Warning</button>
                                            <button type="button" id="sweetalert-error"
                                                class="btn btn-sm btn-danger">Toggle Error</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" id="sweetalert-params" class="btn btn-sm btn-secondary">Click
                                            Me</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" id="sweetalert-image" class="btn btn-sm btn-secondary">Click
                                            Me</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" id="sweetalert-close" class="btn btn-sm btn-secondary">Click
                                            Me</button>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" id="ajax-alert" class="btn btn-sm btn-secondary">Click
                                            Me</button>
                                    </td>
                                </tr>
                            </tbody>
