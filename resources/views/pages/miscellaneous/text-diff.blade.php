...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-action" data-tg-order="2" data-tg-fixed
                data-tg-tour="<p class='mb-3'>Sync the website theme to your system defaults as well as toggle your preference.</p><p class='opacity-50 text-xs'>This also shows how tourGuide can focus on fixed position elements.</p>"
                data-tg-title="Code Example">
