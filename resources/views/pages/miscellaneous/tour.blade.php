                ...
                <div class="card-body">
                    <div>
                            ...
                            <div class="col-lg-5">
                                <div class="text-center mt-4 mb-5">
                                    ...
                                    <p class="text-muted fs-sm">
                                        Our admin panel provides a robust foundation for modern web apps. With support for
                                        multiple frameworks and over a dozen demo variations, developers can build exactly
                                        what they need, fast and easily. Customize with ease and enjoy consistent UI across
                                        projects.
                                    </p>
                                    ...
                                    <div class="d-flex justify-content-center mt-4 flex-wrap gap-2">
                                        ...
                                        <a href="#" class="btn btn-dark" data-tg-order="1"
                                ...
                                <div class="col-xl-3">
                                    <div class="card border-0 p-2 card-h-100">
                                        <div class="card-body pb-0">
                                            ...
                                            <p class="text-muted mb-3">Support for Bootstrap, Tailwind, React, Vue, Angular,
                                                Laravel, and more — use what suits your stack.</p>
                                        </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="card border-0 p-2 card-h-100">
                                        <div class="card-body pb-0">
                                            ...
                                            <p class="text-muted mb-3">Choose from a variety of pre-built demos to match
                                                your use case — from CRM to SaaS dashboards.</p>
                                        </div>
                                        <div class="card-footer border-0 pt-0">
                                            <a class="link-primary fw-semibold" href="#">Know more<i
                                                    class="ti ti-arrow-right ms-2 align-middle"></i></a>
                                ...
                                <div class="col-xl-3">
                                    <div class="card border-0 p-2 card-h-100">
                                        <div class="card-body pb-0">
                                            ...
                                            <p class="text-muted mb-3">Easily tailor colors, layouts, and components to
                                                match your branding and requirements.</p>
                                        </div>
                                        <div class="card-footer border-0 pt-0">
                                            <a class="link-primary fw-semibold" href="#">Know more<i
                                                    class="ti ti-arrow-right ms-2 align-middle"></i></a>
                                ...
                                <div class="col-xl-3">
                                    <div class="card border-0 p-2 card-h-100">
                                        <div class="card-body pb-0">
                                            ...
                                            <p class="text-muted mb-3">Optimized for speed and efficiency, our admin panel
                                                ensures a seamless experience for developers and users alike.</p>
                                        </div>
                                        <div class="card-footer border-0 pt-0">
                                            <a class="link-primary fw-semibold" href="#">Know more<i
                                                    class="ti ti-arrow-right ms-2 align-middle"></i></a>
                        ...
                        <div class="text-center my-4">
                            <button class="btn btn-success" id="thankyou-tour" data-tg-order="7"
                                data-tg-tour="<p>Thanks for exploring! Read the documentation to get the most out of this template.</p>"
                                data-tg-title="Documentation">
