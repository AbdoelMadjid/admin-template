            ...
            <div data-table data-table-rows-per-page="5" class="card">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('third', ['apps', 'ecommerce', 'add-product']) }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h5 class="fs-base my-1"><a
                                                        href="{{ route('third', ['apps', 'ecommerce', 'order-details']) }}"
                                ...
                                <table class="table table-custom table-nowrap table-hover table-centered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="/images/cards/visa.svg" alt="" class="me-2"
                                                    height="28"> xxxx 3490
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><span class="badge badge-soft-success fs-xxs"><i
                                                        class="ti ti-point-filled"></i> Paid</span></td>
                                            <td>
                                                <img src="/images/cards/american-express.svg" alt=""
